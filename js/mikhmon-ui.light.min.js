var i,
  ...
  dropdownbtn = document.getElementsByClassName("dropdown-btn"),
  dropdownContainer = document.getElementsByClassName("dropdown-container");
openNav.addEventListener("click", function () {
  var e = window.innerWidth;
  for (
    e < 800
      ? ((main.style.marginLeft = "0"),
        (sidenav.style = "width: 210px; border-right: 1px solid #c1c1c1"))
      : e > 800 &&
  ...
  (openNav.style.display = "none"), (closeNav.style.display = "block");
}),
  closeNav.addEventListener("click", function () {
    ...
    (openNav.style.display = "block"), (closeNav.style.display = "none");
  }),
