!(function (e, t) {
  ...
  var e = navigator.userAgent,
    ...
    i = /Edge\/(\d+)/.exec(e),
    x = r || n || i,
    k = x && (r ? document.documentMode || 6 : +(i || n)[1]),
    b = !i && /WebKit\//.test(e),
    o = b && /Qt\/\d+\.\d+/.test(e),
    a = !i && /Chrome\//.test(e),
    g = /Opera\//.test(e),
    ...
    d = /Android/.test(e),
    f = u || d || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(e),
    w = u || /Mac/.test(t),
    h = /\bCrOS\b/.test(e),
    p = /win/i.test(t),
    v = g && e.match(/Version\/(\d*\.\d*)/);
  v && (v = Number(v[1])), v && 15 <= v && (b = !(g = !1));
  var y = w && (o || (g && (null == v || v < 12.11))),
    _ = m || (x && 9 <= k);
  function C(e) {
  ...
  function V(e, t, r) {
    for (var n = 0, i = 0; ; ) {
      ...
      -1 == o && (o = e.length);
      var a = o - n;
      if (o == e.length || t <= i + a) return n + Math.min(a, t - i);
  ...
  function le(e, t, r) {
    ...
    (this.input = r),
      ...
      (n.lineDiv = N("div", null, "CodeMirror-code")),
    ...
    var i = N("div", [n.lineSpace], "CodeMirror-lines");
  ...
  function fe(e) {
    ...
    for (
      var t = e.parent, r = H(t.lines, e), n = t.parent;
      n;
      n = (t = n).parent
    )
  ...
  function ge(e, t, r) {
    if ((void 0 === r && (r = null), !(this instanceof ge)))
      return new ge(e, t, r);
  ...
  function _e(e, t) {
    ...
    var r,
      ...
      o = e.first + e.size - 1;
    return t.line > o
      ? ge(o, se(e, o).text.length)
      : ((n = se(e, (r = t).line).text.length),
        null == (i = r.ch) || n < i
          ? ge(r.line, n)
          : i < 0
          ? ge(r.line, 0)
  ...
  function Ce(e, t) {
    for (var r = [], n = 0; n < t.length; n++) r[n] = _e(e, t[n]);
    return r;
  }
  var Se = !1,
    Te = !1;
  ...
  function Ae(e, t) {
    ...
    var r = pe(e, t.from.line) && se(e, t.from.line).markedSpans,
      n = pe(e, t.to.line) && se(e, t.to.line).markedSpans;
    if (!r && !n) return null;
    var i = t.from.ch,
      o = t.to.ch,
      a = 0 == ve(t.from, t.to),
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            if (
              ...
              (n || (n = [])).push(
                new Le(a, l ? null : o.from - t, null == o.to ? null : o.to - t)
              );
            }
          }
        return n;
    ...
    if (s)
      for (var p = 0; p < s.length; ++p) {
        ...
        if ((null != m.to && (m.to += u), null == m.from))
          Me(l, m.marker) || ((m.from = u), c && (l || (l = [])).push(m));
    ...
    if (!c) {
      ...
      if (0 < y && l)
        for (var b = 0; b < l.length; ++b)
          null == l[b].to &&
            (v || (v = [])).push(new Le(l[b].marker, null, null));
  ...
  function Pe(e, t) {
    ...
    var n = e.find(),
      i = t.find(),
      o = ve(n.from, i.from) || Fe(e) - Fe(t);
    if (o) return -o;
    var a = ve(n.to, i.to) || Ie(e) - Ie(t);
    return a || t.id - e.id;
  }
  function Ee(e, t) {
    var r,
      ...
      for (var l = 0; l < a.length; ++l) {
        ...
        if (s.marker.collapsed) {
          var c = s.marker.find(0),
            u = ve(c.from, r) || Fe(s.marker) - Fe(i),
            d = ve(c.to, n) || Ie(s.marker) - Ie(i);
          if (
            !((0 <= u && d <= 0) || (u <= 0 && 0 <= d)) &&
            ((u <= 0 &&
  ...
  function Be(e) {
    for (var t; (t = qe(e)); ) e = t.find(-1, !0).line;
    return e;
  }
  function je(e, t) {
    var r = se(e, t),
  ...
  function Ve(e, t, r) {
    if (null == r.to) {
      ...
      return Ve(e, n.line, Me(n.line.markedSpans, r.marker));
    }
  ...
  function Ge(e) {
    ...
    for (var t, r = e.text.length, n = e; (t = qe(n)); ) {
      var i = t.find(0, !0);
  ...
  function Xe(e) {
    var r = e.display,
      t = e.doc;
    (r.maxLine = se(t, t.first)),
      (r.maxLineLength = Ge(r.maxLine)),
      (r.maxLineChanged = !0),
      t.iter(function (e) {
        var t = Ge(e);
  ...
  function Ze(e, t, r) {
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      o.to == t && (o.from != o.to && "before" == r ? (n = i) : (Ye = i)),
        o.from == t && (o.from != o.to && "before" != r ? (n = i) : (Ye = i));
    }
    return null != n ? n : Ye;
  }
  var Qe = (function () {
    ...
    return function (e, t) {
      var r = "ltr" == t ? "L" : "R";
      if (0 == e.length || ("ltr" == t && !W.test(e))) return !1;
      for (var n, i = e.length, o = [], a = 0; a < i; ++a)
        o.push(
          (n = e.charCodeAt(a)) <= 247
            ? E.charAt(n)
            : 1424 <= n && n <= 1524
            ? "R"
            : 1536 <= n && n <= 1785
      ...
      for (var l = 0, s = r; l < i; ++l) {
        var c = o[l];
        "m" == c ? (o[l] = s) : (s = c);
      }
      for (var u = 0, d = r; u < i; ++u) {
        var f = o[u];
        "1" == f && "r" == d
          ? (o[u] = "n")
          : R.test(f) && "r" == (d = f) && (o[u] = "R");
      }
      for (var h = 1, p = o[0]; h < i - 1; ++h) {
        var m = o[h];
        "+" == m && "1" == p && "1" == o[h + 1]
          ? (o[h] = "1")
          : "," != m || p != o[h + 1] || ("1" != p && "n" != p) || (o[h] = p),
          (p = m);
      }
      for (var g = 0; g < i; ++g) {
        var v = o[g];
      ...
      for (var x = 0, k = r; x < i; ++x) {
        var _ = o[x];
        "L" == k && "1" == _ ? (o[x] = "L") : R.test(_) && (k = _);
      }
      for (var C = 0; C < i; ++C)
        if (H.test(o[C])) {
          var S = void 0;
          for (S = C + 1; S < i && H.test(o[S]); ++S);
          for (
            var T = "L" == (C ? o[C - 1] : r),
              L = T == ("L" == (S < i ? o[S] : r)) ? (T ? "L" : "R") : r,
              M = C;
            M < S;
            ++M
          )
      ...
      for (var N, A = [], O = 0; O < i; )
        if (B.test(o[O])) {
          ...
          for (var I = z; I < O; )
            if (j.test(o[I])) {
              z < I && A.splice(F, 0, new U(1, z, I));
              var P = I;
              for (++I; I < O && j.test(o[I]); ++I);
              A.splice(F, 0, new U(2, P, I)), (z = I);
            } else ++I;
          z < O && A.splice(F, 0, new U(1, z, O));
        }
      return (
        "ltr" == t &&
          (1 == A[0].level &&
            (N = e.match(/^\s+/)) &&
            ((A[0].from = N[0].length), A.unshift(new U(0, 0, N[0].length))),
          1 == X(A).level &&
            (N = e.match(/\s+$/)) &&
            ((X(A).to -= N[0].length), A.push(new U(0, i - N[0].length, i)))),
        "rtl" == t ? A.reverse() : A
      );
    };
  })();
  ...
  function yt(e) {
    if (null == mt) {
      var t = A("span", "​");
      M(e, A("span", [t, document.createTextNode("x")])),
        0 != e.firstChild.offsetHeight &&
          (mt = t.offsetWidth <= 1 && 2 < t.offsetHeight && !(x && k < 8));
    }
    var r = mt
      ? A("span", "​")
      : A(
  ...
  var Nt = {};
  function At(e, t) {
    E(t, Nt.hasOwnProperty(e) ? Nt[e] : (Nt[e] = {}));
  }
  function Ot(e, t) {
    if (!0 === t) return t;
    ...
    (Ft.prototype.column = function () {
      return (
        this.lastColumnPos < this.start &&
          ...
          (this.lastColumnPos = this.start)),
        this.lastColumnValue -
          (this.lineStart ? q(this.string, this.lineStart, this.tabSize) : 0)
      );
    }),
    (Ft.prototype.indentation = function () {
      return (
        q(this.string, null, this.tabSize) -
        (this.lineStart ? q(this.string, this.lineStart, this.tabSize) : 0)
      );
    }),
          ...
          (n.state = !0),
            Vt(
              ...
              function (e, t) {
                for (var r = a; l < e; ) {
                  var n = s[a];
                  e < n && s.splice(a, 1, e, s[a + 1], n),
                    (a += 2),
                    (l = Math.min(e, n));
                }
                if (t)
                  if (o.opaque)
                    s.splice(r, a - r, e, "overlay " + t), (a = r + 2);
                  else
                    for (; r < a; r += 2) {
                      var i = s[r + 1];
                      s[r + 1] = (i ? i + " " : "") + "overlay " + t;
  ...
  function Wt(r, n, e) {
    var t = r.doc,
      i = r.display;
    if (!t.mode.startState) return new Pt(t, !0, n);
    var o = (function (e, t, r) {
        for (
          ...
          if (
            c &&
            (!r || l + (c instanceof It ? c.lookAhead : 0) <= o.modeFrontier)
          )
            return l;
          var u = q(s.text, null, e.options.tabSize);
          (null == i || u < n) && ((i = l - 1), (n = u));
        }
        return i;
      })(r, n, e),
      a = o > t.first && se(t, o - 1).stateAfter,
      l = a ? Pt.fromSaved(t, a, o) : new Pt(t, zt(t.mode), o);
    return (
      ...
      e && (t.modeFrontier = l.line),
      l
    );
  }
  function Ht(e, t, r, n) {
    var i = e.doc.mode,
      o = new Ft(t, e.options.tabSize, r);
    for (o.start = o.pos = n || 0, "" == t && Rt(i, r.state); !o.eol(); )
      Bt(i, o, r.state), (o.start = o.pos);
  }
  function Rt(e, t) {
  ...
  (Pt.prototype.lookAhead = function (e) {
    ...
    (Pt.fromSaved = function (e, t, r) {
      return t instanceof It
        ? new Pt(e, Ot(e.mode, t.state), r, t.lookAhead)
        : new Pt(e, Ot(e.mode, t), r);
    }),
  ...
  function Ut(e, t, r, n) {
    var i,
      ...
      a = e.doc,
      l = a.mode,
      s = se(a, (t = _e(a, t)).line),
      c = Wt(e, t.line, r),
      u = new Ft(s.text, e.options.tabSize, c);
    for (n && (o = []); (n || u.pos < t.ch) && !u.eol(); )
      (u.start = u.pos),
        (i = Bt(l, u, c.state)),
        n && o.push(new jt(u, i, Ot(a.mode, c.state)));
  ...
  function Vt(e, t, r, n, i, o, a) {
    ...
    var s,
      c = 0,
      u = null,
      d = new Ft(t, e.options.tabSize, n),
      f = e.options.addModeClass && [null];
    for ("" == t && Kt(Rt(r, n.state), o); !d.eol(); ) {
      if (
        (d.pos > e.options.maxHighlightLength
          ? ((l = !1), a && Ht(e, t, n, d.pos), (d.pos = t.length), (s = null))
          : (s = Kt(Bt(r, d, n.state, f), o)),
        f)
      ) {
        var h = f[0].name;
        h && (s = "m-" + (s ? h + " " + s : h));
  ...
  var $t = function (e, t, r) {
    (this.text = e), ze(this, t), (this.height = r ? r(this) : 1);
  };
  ...
  function Zt(e, t) {
    var r = N("span", null, null, b ? "padding-right: .1px" : null),
      n = {
    ...
    for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
      ...
      (n.pos = 0),
        ...
        bt(e.display.measure) &&
          (a = Je(o, e.doc.direction)) &&
          (n.addToken = er(n.addToken, a)),
        (n.map = []),
        rr(o, n, qt(e, o, t != e.display.externalMeasured && fe(o))),
        o.styleClasses &&
    ...
    if (t) {
      ...
      if (c.test(t)) {
        ...
        for (var d = 0; ; ) {
          ...
          if (h) {
            var p = document.createTextNode(s.slice(d, d + h));
            x && k < 9 ? l.appendChild(A("span", [p])) : l.appendChild(p),
              e.map.push(e.pos, e.pos + h, p),
              (e.col += h),
              (e.pos += h);
          }
          if (!f) break;
          ...
          if ("\t" == f[0]) {
            ...
            "\r" == f[0] || "\n" == f[0]
              ...
              : ((m = e.cm.options.specialCharPlaceholder(f[0])).setAttribute(
                ...
                x && k < 9 ? l.appendChild(A("span", [m])) : l.appendChild(m)),
              (e.col += 1);
  ...
  function er(d, f) {
    return function (e, t, r, n, i, o, a) {
      ...
      for (var l = e.pos, s = l + t.length; ; ) {
        for (
          var c = void 0, u = 0;
          u < f.length && !((c = f[u]).to > l && c.from <= l);
          u++
        );
        if (c.to >= s) return d(e, t, r, n, i, o, a);
        d(e, t.slice(0, c.to - l), r, n, null, o, a),
          (n = null),
          (t = t.slice(c.to - l)),
          (l = c.to);
      }
  ...
  function rr(e, t, r) {
    ...
    if (n)
      for (
        var a, l, s, c, u, d, f, h = i.length, p = 0, m = 1, g = "", v = 0;
        ;

      ) {
        if (v == p) {
          (s = c = u = l = ""), (d = f = null), (v = 1 / 0);
          for (var y = [], b = void 0, w = 0; w < n.length; ++w) {
            ...
            if ("bookmark" == k.type && x.from == p && k.widgetNode) y.push(k);
              ...
              k.collapsed && (!d || Pe(d.marker, k) < 0) && (d = x);
      ...
      for (var N = 1; N < r.length; N += 2)
        t.addToken(t, i.slice(o, (o = r[N])), Yt(r[N + 1], t.cm.options));
  }
  function nr(e, t, r) {
    (this.line = t),
      ...
      (this.size = this.rest ? fe(X(this.rest)) - r + 1 : 1),
      (this.node = this.text = null),
      (this.hidden = Ke(e, t));
  }
  function ir(e, t, r) {
    for (var n, i = [], o = t; o < r; o = n) {
      var a = new nr(e.doc, se(e.doc, o), o);
      (n = o + a.size), i.push(a);
    }
    return i;
  }
  ...
  function br(e) {
    ...
    if (!O(document.body, e.node)) {
      ...
      e.coverGutter &&
        ...
        M(t.display.measure, A("div", [e.node], null, r));
    }
  ...
  function Ar(e, t) {
    ...
    n && !n.text
      ? (n = null)
      : n && n.changes && (cr(e, n, r, tn(e)), (e.curOp.forceUpdate = !0)),
      n ||
        (n = (function (e, t) {
          var r = fe((t = Be(t))),
            ...
            if (3 == a.nodeType) {
              for (var u = 0; u < 4; u++) {
                ...
                for (
                  ...
                  ie(t.line.text.charAt(o.coverStart + s));

                )
                  ++s;
                if (
                  (i =
                    x && k < 9 && 0 == l && s == o.coverEnd - o.coverStart
                      ? a.parentNode.getBoundingClientRect()
                      : Ir(S(a, l, s).getClientRects(), n)).left ||
                  i.right ||
                  0 == l
                )
                  break;
                ...
                (i = (function (e, t) {
                  if (
                    ...
                    !(function (e) {
                      ...
                      return (Ct = 1 < Math.abs(r.left - n.left));
                    })(e)
                  )
                    return t;
              ...
              0 < l && (c = n = "right"),
                (i =
                  e.options.lineWrapping && 1 < (d = a.getClientRects()).length
                    ? d["right" == n ? d.length - 1 : 0]
                    : a.getBoundingClientRect());
            }
            if (x && k < 9 && !l && (!i || (!i.left && !i.right))) {
  ...
  var Dr,
    zr = { left: 0, right: 0, top: 0, bottom: 0 };
  function Fr(e, t, r) {
  ...
  function Ur(e, t, r, n, i) {
    return n || (n = se(e.doc, t.line)), Br(e, n, Mr(e, n, t.ch, i), r);
  }
  function Kr(n, e, i, o, a, l) {
    function s(e, t) {
      var r = Or(n, a, e, t ? "right" : "left", l);
      return t ? (r.left = r.right) : (r.right = r.left), Br(n, o, r, i);
    }
    (o = o || se(n.doc, e.line)), a || (a = Ar(n, o));
    var c = Je(o, n.doc.direction),
      t = e.ch,
      r = e.sticky;
    if (
      (t >= o.text.length
      ...
      return s("before" == r ? t - 1 : t, "before" == r);
    function u(e, t, r) {
      return s(r ? e - 1 : e, (1 == c[t].level) != r);
    }
    var d = Ze(c, t, r),
      f = Ye,
      h = u(t, d, "before" == r);
    return null != f && (h.other = u(t, f, "before" != r)), h;
  }
  function Vr(e, t) {
    var r = 0;
    (t = _e(e.doc, t)), e.options.lineWrapping || (r = en(e.display) * t.ch);
    var n = se(e.doc, t.line),
      i = $e(n) + xr(e.display);
  ...
  function Gr(e, t, r) {
    ...
    var i = he(n, r),
      o = n.first + n.size - 1;
    if (o < i)
      return $r(n.first + n.size - 1, se(n, o).text.length, null, !0, 1);
    t < 0 && (t = 0);
    for (var a = se(n, i); ; ) {
      var l = Qr(e, a, i, t, r),
        s = He(a, l.ch + (0 < l.xRel ? 1 : 0));
      if (!s) return l;
      var c = s.find(1);
  ...
  function Yr(e, t, r, n) {
    return r || (r = Ar(e, t)), Xr(e, t, r, Br(e, t, Or(e, r, n), "line").top);
  }
  function Zr(e, t, r, n) {
  ...
  function Qr(r, e, t, n, i) {
    ...
    var o = Ar(r, e),
      ...
      s = e.text.length,
      c = !0,
      u = Je(e, r.doc.direction);
    if (u) {
      var d = (r.options.lineWrapping
        ? function (e, t, r, n, i, o, a) {
            ...
            for (var u = null, d = null, f = 0; f < i.length; f++) {
              ...
              if (!(h.from >= c || h.to <= s)) {
                var p = 1 != h.level,
                  m = Or(e, n, p ? Math.min(c, h.to) - 1 : Math.max(s, h.from))
                    .right,
                  g = m < o ? o - m + 1e9 : m - o;
                (!u || g < d) && ((u = h), (d = g));
              }
        ...
        : function (n, i, o, a, l, s, c) {
            var e = ae(
                function (e) {
                  ...
                  return Zr(
                    Kr(
                      n,
                      ge(o, r ? t.to : t.from, r ? "before" : "after"),
                      "line",
                      i,
                      a
                    ),
            ...
            if (0 < e) {
              var r = 1 != t.level,
                u = Kr(
                  n,
                  ge(o, r ? t.from : t.to, r ? "after" : "before"),
                  "line",
                  i,
                  a
                );
              Zr(u, s, c, !0) && u.top > c && (t = l[e - 1]);
            }
            return t;
          })(r, e, t, o, u, n, i);
      ...
      c || (g != s && g != l) || g++,
        (h =
          0 == g
            ...
            : g == e.text.length
            ? "before"
            : Or(r, o, g - (c ? 1 : 0)).bottom + a <= i == c
            ? "after"
            : "before");
      var w = Kr(r, ge(t, g, h), "line", e, o);
      (f = w.left), (v = i < w.top || i >= w.bottom);
    }
    return $r(t, (g = oe(e.text, g, 1)), h, v, n - f);
  }
  function Jr(e) {
    ...
    if (null == Dr) {
      Dr = A("pre");
      for (var t = 0; t < 49; ++t)
        Dr.appendChild(document.createTextNode("x")), Dr.appendChild(A("br"));
      Dr.appendChild(document.createTextNode("x"));
    }
    M(e.measure, Dr);
    var r = Dr.offsetHeight / 50;
    return 3 < r && (e.cachedTextHeight = r), L(e.measure), r || 1;
  }
  function en(e) {
  ...
  function nn(n) {
    var i = Jr(n.display),
      ...
      a = o && Math.max(5, n.display.scroller.clientWidth / en(n.display) - 3);
    return function (e) {
  ...
  function an(e, t, r, n) {
    ...
    var s,
      c = Gr(e, o, a);
    if (n && 1 == c.xRel && (s = se(e.doc, c.line).text).length == c.ch) {
      var u = q(s, s.length, e.options.tabSize) - s.length;
      c = ge(
        c.line,
        Math.max(0, Math.round((o - _r(e.display).left) / en(e.display)) - u)
      );
    }
    return c;
  }
  ...
  function fn(a, e, t) {
    var r = a.display,
      ...
      o = _r(a.display),
      T = o.left,
      L = Math.max(r.sizerWidth, Sr(a) - r.sizer.offsetLeft) - o.right,
      M = "ltr" == n.direction;
    function N(e, t, r, n) {
      t < 0 && (t = 0),
        (t = Math.round(t)),
    ...
    function l(r, y, b) {
      ...
      return (
        (function (e, t, r, n) {
          ...
          i || n(t, r, "ltr");
        })(S, y || 0, null == b ? k : b, function (e, t, r, n) {
          var i = "ltr" == r,
            o = _(e, i ? "left" : "right"),
            a = _(t - 1, i ? "right" : "left"),
            l = null == y && 0 == e,
            s = null == b && t == k,
            c = 0 == n,
            u = !S || n == S.length - 1;
          if (a.top - o.top <= 3) {
            var d = (M ? s : l) && u,
              f = (M ? l : s) && c ? T : (i ? o : a).left,
              h = d ? L : (i ? a : o).right;
            N(f, o.top, h - f, o.bottom);
          } else {
            var p, m, g, v;
            i
              ? ((p = M && l && c ? T : o.left),
              ...
              : ((p = M ? C(e, r, "before") : T),
                ...
                (g = !M && s && u ? T : a.left),
                (v = M ? C(t, r, "after") : L)),
              N(p, o.top, m - p, o.bottom),
              o.bottom < a.top && N(T, o.bottom, null, a.top),
              N(g, a.top, v - g, a.bottom);
          }
          (!w || dn(o, w) < 0) && (w = o),
            dn(a, w) < 0 && (w = a),
            (!x || dn(o, x) < 0) && (x = o),
    ...
    var s = e.from(),
      c = e.to();
    if (s.line == c.line) l(s.line, s.ch, c.ch);
    else {
      var u = se(n, s.line),
        d = se(n, c.line),
        f = Be(u) == Be(d),
        h = l(s.line, s.ch, f ? u.text.length + 1 : null).end,
        p = l(c.line, f ? 0 : null, c.ch).start;
      f &&
        (h.top < p.top - 2
          ? (N(h.right, h.top, null, h.bottom), N(T, p.top, p.left, p.bottom))
          : N(h.right, h.top, p.left - h.right, h.bottom)),
        h.bottom < p.top && N(T, h.bottom, null, p.top);
    }
    t.appendChild(i);
  }
  function hn(e) {
  ...
  function yn(e) {
    for (
      ...
      if (!i.hidden) {
        ...
        if (
          (a < 2 && (a = Jr(t)),
          (0.005 < u || u < -0.005) && (de(i.line, a), bn(i.line), i.rest))
        )
          for (var d = 0; d < i.rest.length; d++) bn(i.rest[d]);
        if (l > e.display.sizerWidth) {
          var f = Math.ceil(l / en(e.display));
  ...
  function wn(e, t, r) {
    ...
    if (r && r.ensure) {
      var l = r.ensure.from.line,
        s = r.ensure.to.line;
      l < o
        ? (a = he(t, $e(se(t, (o = l))) + e.wrapper.clientHeight))
        : Math.min(s, t.lastLine()) >= a &&
          ((o = he(t, $e(se(t, s)) - e.wrapper.clientHeight)), (a = s));
    }
  ...
  function _n(e, t) {
    ...
    var d =
      ...
      f = Sr(e) - (e.options.fixedGutter ? r.gutters.offsetWidth : 0),
      h = t.right - t.left > f;
    return (
      h && (t.right = t.left + f),
      t.left < 10
  ...
  function Ln(e) {
    ...
    t &&
      ...
      Mn(e, Vr(e, t.from), Vr(e, t.to), t.margin));
  }
  function Mn(e, t, r, n) {
    var i = _n(e, {
  ...
  function Nn(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 ||
      (m || ai(e, { top: t }), An(e, t, !0), m && ai(e), ti(e, 100));
  }
  function An(e, t, r) {
    (t = Math.min(
  ...
  function Dn(e) {
    ...
    return {
      ...
      docHeight: n,
      scrollHeight: n + Cr(e) + t.barHeight,
  ...
  (zn.prototype.update = function (e) {
    ...
    (zn.prototype.enableZeroWidthBar = function (r, n, i) {
  ...
  function qn(r) {
    r.display.scrollbars &&
      ...
      (r.display.scrollbars = new En[r.options.scrollbarStyle](
        function (e) {
        ...
        function (e, t) {
          "horizontal" == t ? On(r, e) : Nn(r, e);
        },
        r
      )),
      r.display.scrollbars.addClass &&
        z(r.display.wrapper, r.display.scrollbars.addClass);
  }
  var Wn = 0;
  function Hn(e) {
    var t;
    ...
    t &&
      (function (e, t) {
        ...
        !(function (e) {
          ...
          for (var l = 0; l < t.length; l++) Kn(t[l]);
        })(e);
      });
  }
  function Bn(e) {
    ...
    !(r = (t = n).display).scrollbarsClipped &&
      ...
      (r.heightForcer.style.height = Cr(t) + "px"),
      (r.sizer.style.marginBottom = -r.nativeBarWidth + "px"),
      (r.sizer.style.borderRightWidth = Cr(t) + "px"),
      (r.scrollbarsClipped = !0)),
      e.updateMaxLine && Xe(n),
      (e.mustUpdate =
        e.viewChanged ||
        e.forceUpdate ||
        null != e.scrollTop ||
  ...
  function jn(e) {
    ...
    e.updatedDisplay && yn(t),
      ...
      r.maxLineChanged &&
        ...
        ((e.adjustWidthTo = Mr(t, r.maxLine, r.maxLine.text.length).left + 3),
        (t.display.sizerWidth = e.adjustWidthTo),
        (e.barMeasure.scrollWidth = Math.max(
          r.scroller.clientWidth,
          r.sizer.offsetLeft + e.adjustWidthTo + Cr(t) + t.display.barWidth
        )),
        (e.maxScrollLeft = Math.max(
          0,
          r.sizer.offsetLeft + e.adjustWidthTo - Sr(t)
        ))),
  ...
  function Kn(e) {
    ...
    null != e.scrollTop && An(t, e.scrollTop, e.forceScroll),
    ...
    e.scrollToPos) &&
      (function (e, t) {
          ...
          if (
            ...
            var o = A(
              ...
              "position: absolute;\n                         top: " +
                ...
                "px;\n                         height: " +
                (t.bottom - t.top + Cr(e) + r.barHeight) +
                "px;\n                         left: " +
                t.left +
                "px; width: " +
        ...
        (function (e, t, r, n) {
          ...
          null == n && (n = 0),
            e.options.lineWrapping ||
              ...
              (r =
                "before" ==
                (t = t.ch
                  ? ge(t.line, "before" == t.sticky ? t.ch - 1 : t.ch, "after")
                  : t).sticky
                  ? ge(t.line, t.ch + 1, "before")
                  : t);
          for (var o = 0; o < 5; o++) {
            var a = !1,
              l = Kr(e, t),
            ...
            if (
              (null != c.scrollTop &&
                (Nn(e, c.scrollTop),
                1 < Math.abs(e.doc.scrollTop - u) && (a = !0)),
              null != c.scrollLeft &&
                (On(e, c.scrollLeft),
                1 < Math.abs(e.doc.scrollLeft - d) && (a = !0)),
              !a)
            )
              break;
          }
          ...
          t,
          _e(n, e.scrollToPos.from),
          _e(n, e.scrollToPos.to),
    ...
    if (o)
      for (var l = 0; l < o.length; ++l)
        o[l].lines.length && it(o[l], "unhide");
  ...
  function Yn(e, t, r, n) {
    ...
    if (
      ...
      Te && je(e.doc, t) < i.viewTo && Qn(e);
    else if (r <= i.viewFrom)
      Te && Ue(e.doc, r + n) > i.viewFrom
        ? Qn(e)
  ...
  function ti(e, t) {
    e.doc.highlightFrontier < e.display.viewTo &&
      e.state.highlight.set(t, P(ri, e));
  }
  function ri(s) {
    var c = s.doc;
    if (!(c.highlightFrontier >= s.display.viewTo)) {
      var u = +new Date() + s.options.workTime,
        d = Wt(s, c.highlightFrontier),
        f = [];
      c.iter(
        d.line,
        Math.min(c.first + c.size, s.display.viewTo + 500),
        function (e) {
          if (d.line >= s.display.viewFrom) {
            var t = e.styles,
              r =
                e.text.length > s.options.maxHighlightLength
                  ? Ot(c.mode, d.state)
                  : null,
              n = Et(s, e, d, !0);
            r && (d.state = r), (e.styles = n.styles);
            ...
            for (
              ...
              a = t[l] != e.styles[l];
            a && f.push(d.line), (e.stateAfter = d.save()), d.nextLine();
          } else
            e.text.length <= s.options.maxHighlightLength && Ht(s, e.text, d),
              (e.stateAfter = d.line % 5 == 0 ? d.save() : null),
              d.nextLine();
          if (+new Date() > u) return ti(s, s.options.workDelay), !0;
        }
      ),
        (c.highlightFrontier = d.line),
        (c.modeFrontier = Math.max(c.modeFrontier, d.line)),
        f.length &&
          Vn(s, function () {
            for (var e = 0; e < f.length; e++) Zn(s, f[e], "text");
          });
    }
  }
  ...
  function ii(e, t) {
    ...
    (s = o),
      (c = a),
      0 == (u = (l = e).display).view.length || s >= u.viewTo || c <= u.viewFrom
        ? ((u.view = ir(l, s, c)), (u.viewFrom = s))
        : (u.viewFrom > s
            ? (u.view = ir(l, s, u.viewFrom).concat(u.view))
            : u.viewFrom < s && (u.view = u.view.slice(ln(l, s))),
          (u.viewFrom = s),
          u.viewTo < c
            ? (u.view = u.view.concat(ir(l, u.viewTo, c)))
            : u.viewTo > c && (u.view = u.view.slice(0, ln(l, c)))),
      (u.viewTo = c),
      (r.viewOffset = $e(se(e.doc, r.viewFrom))),
    ...
    return (
      ...
      (function (r, e, t) {
        ...
        for (var s = n.view, c = n.viewFrom, u = 0; u < s.length; u++) {
          var d = s[u];
          if (d.hidden);
          else if (d.node && d.node.parentNode == o) {
            for (; a != d.node; ) a = l(a);
            var f = i && null != e && e <= c && d.lineNumber;
            d.changes &&
              (-1 < H(d.changes, "gutter") && (f = !1), cr(r, d, c, t)),
              f &&
                (L(d.lineNumber),
                d.lineNumber.appendChild(
                  document.createTextNode(me(r.options, c))
                )),
            ...
            var h =
              ...
              (y = dr((p = r), (m = d))),
              (m.text = m.node = y.pre),
              y.bgClass && (m.bgClass = y.bgClass),
              y.textClass && (m.textClass = y.textClass),
              hr(p, m),
              pr(p, m, g, v),
              gr(p, m, v),
              m.node);
  ...
  function oi(e, t) {
    for (
      ...
      ((n && e.options.lineWrapping && t.oldDisplayWidth != Sr(e)) ||
        (r &&
          null != r.top &&
  ...
  function ci(e) {
    ...
    for (var n = 0; n < r.length; ++n) {
      ...
      "CodeMirror-linenumbers" == i &&
        ((e.display.lineGutter = o).style.width =
  ...
  function mi(e, t) {
    ...
    if ((n && l) || (i && s)) {
      ...
      if (n && !m && !g && null != fi)
        return (
          i && s && Nn(e, Math.max(0, a.scrollTop + i * fi)),
          On(e, Math.max(0, a.scrollLeft + n * fi)),
          (!i || (i && s)) && ct(t),
  ...
  x ? (fi = -0.53) : m ? (fi = 15) : a ? (fi = -0.7) : s && (fi = -1 / 3);
  var gi = function (e, t) {
  ...
  (gi.prototype.primary = function () {
    ...
    (gi.prototype.deepCopy = function () {
      for (var e = [], t = 0; t < this.ranges.length; t++)
        e[t] = new vi(be(this.ranges[t].anchor), be(this.ranges[t].head));
    ...
    (gi.prototype.contains = function (e, t) {
      ...
      for (var r = 0; r < this.ranges.length; r++) {
        var n = this.ranges[r];
        if (0 <= ve(t, n.from()) && ve(e, n.to()) <= 0) return r;
      }
      return -1;
    });
  var vi = function (e, t) {
  ...
  function yi(e, t, r) {
    ...
    for (var o = 1; o < t.length; o++) {
      var a = t[o],
        l = t[o - 1],
        s = ve(l.to(), a.from());
      if (n && !a.empty() ? 0 < s : 0 <= s) {
        var c = xe(l.from(), a.from()),
          u = we(l.to(), a.to()),
          d = l.empty() ? a.from() == a.head : l.from() == l.head;
        o <= r && --r, t.splice(--o, 2, new vi(d ? u : c, d ? c : u));
      }
    }
    return new gi(t, r);
  }
  ...
  function xi(e, t) {
    ...
    var r = e.line + t.text.length - (t.to.line - t.from.line) - 1,
      n = e.ch;
    return e.line == t.to.line && (n += wi(t).ch - t.to.ch), ge(r, n);
  }
  function ki(e, t) {
  ...
  function _i(e, t, r) {
    return e.line == t.line
      ? ge(r.line, e.ch - t.ch + r.ch)
      : ge(r.line + (e.line - t.line), e.ch);
  }
  function Ci(e) {
    (e.doc.mode = Mt(e.options, e.doc.modeOption)), Si(e);
  }
  function Si(e) {
  ...
  function Li(e, n, t, i) {
    ...
    function a(e, t) {
      for (var r = [], n = e; n < t; ++n) r.push(new $t(c[n], o(n), i));
      return r;
    }
    var l = n.from,
      s = n.to,
    ...
    if (n.full)
      ...
      if (1 == c.length)
        r(u, u.text.slice(0, l.ch) + f + u.text.slice(s.ch), h);
      else {
        var g = a(1, c.length - 1);
        g.push(new $t(f + u.text.slice(s.ch), h, i)),
          r(u, u.text.slice(0, l.ch) + c[0], o(0)),
          e.insert(l.line + 1, g);
      }
    else if (1 == c.length)
      r(u, u.text.slice(0, l.ch) + c[0] + d.text.slice(s.ch), o(0)),
        e.remove(l.line + 1, p);
    else {
      r(u, u.text.slice(0, l.ch) + c[0], o(0)), r(d, f + d.text.slice(s.ch), h);
  ...
  function Ai(e) {
    ("rtl" == e.doc.direction ? z : T)(e.display.lineDiv, "CodeMirror-rtl");
  }
  function Oi(e) {
    (this.done = []),
      (this.undone = []),
  ...
  function Di(e, t) {
    var r = { from: be(t.from), to: wi(t), text: ce(e, t.from, t.to) };
    return (
      Ei(e, r, t.from.line, t.to.line + 1),
      Mi(
        e,
        function (e) {
          return Ei(e, r, t.from.line, t.to.line + 1);
        },
        !0
      ),
      r
  ...
  function Fi(e, t, r, n) {
    ...
    if (
      ...
      (o =
        (l = i).lastOp == n
          ? (zi(l.done), X(l.done))
          : l.done.length && !X(l.done).ranges
          ? X(l.done)
          : 1 < l.done.length && !l.done[l.done.length - 2].ranges
          ? (l.done.pop(), X(l.done))
          : void 0)
    )
      (a = X(o.changes)),
        0 == ve(t.from, t.to) && 0 == ve(t.from, a.to)
          ? (a.to = wi(t))
          : o.changes.push(Di(e, t));
    else {
      var c = X(i.done);
      for (
        (c && c.ranges) || Pi(e.sel, i.done),
          o = { changes: [Di(e, t)], generation: i.generation },
          i.done.push(o);
  ...
  function Ii(e, t, r, n) {
    ...
    (u &&
      c.lastSelOrigin == u &&
      ((c.lastModTime == c.lastSelTime && c.lastOrigin == u) ||
        ((i = e),
        (o = u),
        (a = X(c.done)),
        (l = t),
      ...
      ? (c.done[c.done.length - 1] = t)
      : Pi(t, c.done),
      (c.lastSelTime = +new Date()),
      (c.lastSelOrigin = u),
      (c.lastSelOp = r),
      n && !1 !== n.clearRedo && zi(c.undone);
  }
  function Pi(e, t) {
    var r = X(t);
  ...
  function Wi(e, t) {
    var r = (function (e, t) {
        var r = t["spans_" + e.id];
        if (!r) return null;
        for (var n = [], i = 0; i < t.text.length; ++i) n.push(qi(r[i]));
        return n;
      })(e, t),
      n = Ae(e, t);
    if (!r) return n;
  ...
  function Bi(e, t, r, n, i) {
    null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
      $i(e, new gi([Ri(e.sel.primary(), t, r, i)], 0), n);
  }
  function ji(e, t, r) {
    for (
      ...
      n[o] = Ri(e.sel.ranges[o], t[o], null, i);
    $i(e, yi(e.cm, n, e.sel.primIndex), r);
  }
  function Ui(e, t, r, n) {
    var i = e.sel.ranges.slice(0);
    (i[t] = r), $i(e, yi(e.cm, i, e.sel.primIndex), n);
  }
  function Ki(e, t, r, n) {
    $i(e, bi(t, r), n);
  }
  function Vi(e, t, r) {
    var n = e.history.done,
      i = X(n);
    i && i.ranges ? Gi(e, (n[n.length - 1] = t), r) : $i(e, t, r);
  }
  function $i(e, t, r) {
    Gi(e, t, r), Ii(e, e.sel, e.cm ? e.cm.curOp.id : NaN, r);
  }
  function Gi(e, t, r) {
    var n, i, o, a;
    (lt(e, "beforeSelectionChange") ||
      ...
      (a = {
        ...
        update: function (e) {
          this.ranges = [];
          for (var t = 0; t < e.length; t++)
            this.ranges[t] = new vi(_e(n, e[t].anchor), _e(n, e[t].head));
        },
        origin: o && o.origin,
      }),
      it(n, "beforeSelectionChange", n, a),
      n.cm && it(n.cm, "beforeSelectionChange", n.cm, a),
      (t = a.ranges != i.ranges ? yi(n.cm, a.ranges, a.ranges.length - 1) : i)),
      Xi(
        e,
        Zi(
          e,
  ...
  function eo(e, t, r, n) {
    return r < 0 && 0 == t.ch
      ? t.line > e.first
        ? _e(e, ge(t.line - 1))
        : null
      : 0 < r && t.ch == (n || se(e, t.line)).text.length
      ? t.line < e.first + e.size - 1
        ? ge(t.line + 1, 0)
        : null
      : new ge(t.line, t.ch + r);
  }
  function to(e) {
  ...
  function ro(i, e, t) {
    ...
    return (
      ...
      i.cm && it(i.cm, "beforeChange", i.cm, o),
      o.canceled
        ? null
  ...
  function no(e, t, r) {
    if (e.cm) {
      if (!e.cm.curOp) return $n(e.cm, no)(e, t, r);
        ...
        (function (e, t, r) {
          ...
          for (var i = [{ from: t, to: r }], o = 0; o < n.length; ++o)
            for (var a = n[o], l = a.find(0), s = 0; s < i.length; ++s) {
              var c = i[s];
              if (!(ve(c.to, l.from) < 0 || 0 < ve(c.from, l.to))) {
                var u = [s, 1],
                  d = ve(c.from, l.from),
                  f = ve(c.to, l.to);
                (d < 0 || (!a.inclusiveLeft && !d)) &&
                  u.push({ from: c.from, to: l.from }),
                  (0 < f || (!a.inclusiveRight && !f)) &&
  ...
  function io(e, r) {
    if (1 != r.text.length || "" != r.text[0] || 0 != ve(r.from, r.to)) {
      var t = ki(e, r);
      Fi(e, r, t, e.cm ? e.cm.curOp.id : NaN), lo(e, r, t, Ae(e, r));
      var n = [];
      Mi(e, function (e, t) {
        t || -1 != H(n, e.history) || (fo(e.history, r), n.push(e.history)),
          lo(e, r, null, Ae(e, r));
      });
    }
  }
    ...
    if (!t || e) {
      for (
        var a,
          r = i.history,
          n = i.sel,
          l = "undo" == o ? r.done : r.undone,
          s = "undo" == o ? r.undone : r.done,
          c = 0;
        c < l.length &&
        ((a = l[c]), e ? !a.ranges || a.equals(i.sel) : a.ranges);
        c++
      );
      if (c != l.length) {
        for (r.lastOrigin = r.lastSelOrigin = null; ; ) {
          ...
          if ((Pi(a, s), e && !a.equals(i.sel)))
            return void $i(i, a, { clearRedo: !1 });
          n = a;
        }
        var u = [];
        Pi(n, s),
          s.push({ changes: u, generation: r.generation }),
          (r.generation = a.generation || ++r.maxGeneration);
        for (
          var d = lt(i, "beforeChange") || (i.cm && lt(i.cm, "beforeChange")),
            f = function (e) {
              var r = a.changes[e];
              if (((r.origin = o), d && !ro(i, r, !1)))
                return (l.length = 0), {};
              u.push(Di(i, r));
              var t = e ? ki(i, r) : X(l);
              lo(i, r, t, Wi(i, r)),
                !e && i.cm && i.cm.scrollIntoView({ from: r.from, to: wi(r) });
              var n = [];
              Mi(i, function (e, t) {
                t ||
                  -1 != H(n, e.history) ||
                  (fo(e.history, r), n.push(e.history)),
                  lo(e, r, null, Wi(e, r));
              });
            },
            h = a.changes.length - 1;
          0 <= h;
          --h
        ) {
          var p = f(h);
  ...
  function lo(e, t, r, n) {
    if (e.cm && !e.cm.curOp) return $n(e.cm, lo)(e, t, r, n);
      ...
      t.to.line > o &&
        ...
        e.cm
          ? (function (e, t, r) {
              ...
              -1 < n.sel.contains(t.from, t.to) && at(e);
              Li(n, t, r, nn(e)),
                e.options.lineWrapping ||
              ...
              t.full
                ? Yn(e)
                : o.line != a.line || 1 != t.text.length || Ti(e.doc, t)
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      if (o.ranges) {
        ...
        for (var s = 0; s < o.changes.length; ++s) {
          var c = o.changes[s];
          if (r < c.from.line)
            (c.from = ge(c.from.line + n, c.from.ch)),
              (c.to = ge(c.to.line + n, c.to.ch));
          else if (t <= c.to.line) {
            a = !1;
            break;
          }
  ...
  function ho(e, t, r, n) {
    var i = t,
      o = t;
    return (
      "number" == typeof t ? (o = se(e, ke(e, t))) : (i = fe(t)),
  ...
  (vi.prototype.from = function () {
    ...
    (mo.prototype = {
      ...
      removeInner: function (e, t) {
        ...
        if (
          this.size - t < 25 &&
          (1 < this.children.length || !(this.children[0] instanceof po))
        ) {
          var l = [];
          this.collapse(l),
  ...
  function vo(e, t, r) {
    $e(t) < ((e.curOp && e.curOp.scrollTop) || e.doc.scrollTop) && Cn(e, r);
  }
  (go.prototype.clear = function () {
    ...
    (go.prototype.changed = function () {
      ...
      var i = br(this) - t;
      i &&
        (Ke(this.doc, n) || de(n, n.height + i),
        r &&
          Vn(r, function () {
            (r.curOp.forceUpdate = !0),
              vo(r, n, i),
              lr(r, "lineWidgetChanged", r, e, fe(n));
          }));
    }),
    st(go);
  var yo = 0,
  ...
  function wo(t, n, i, e, r) {
    ...
    if (t.cm && !t.cm.curOp) return $n(t.cm, wo)(t, n, i, e, r);
    var o = new bo(t, r),
      a = ve(n, i);
    if ((e && E(e, o, !1), 0 < a || (0 == a && !1 !== o.clearWhenEmpty)))
      return o;
    if (
      (o.replacedWith &&
        ((o.collapsed = !0),
      ...
      if (
        Re(t, n.line, n, i, o) ||
        (n.line != i.line && Re(t, i.line, n, i, o))
      )
        throw new Error(
    ...
    o.addToHistory && Fi(t, { from: n, to: i, origin: "markText" }, t.sel, NaN);
    var l,
      s = n.line,
      c = t.cm;
    if (
      (t.iter(s, i.line + 1, function (e) {
        var t, r;
        c &&
          o.collapsed &&
          !c.options.lineWrapping &&
          Be(e) == c.display.maxLine &&
          (l = !0),
          o.collapsed && s != n.line && de(e, 0),
          (t = e),
          (r = new Le(o, s == n.line ? n.ch : null, s == i.line ? i.ch : null)),
      ...
      if ((l && (c.curOp.updateMaxLine = !0), o.collapsed))
        ...
        for (var u = n.line; u <= i.line; u++) Zn(c, u, "text");
      o.atomic && Yi(c.doc), lr(c, "markerAdded", c, o);
    }
    return o;
  }
  (bo.prototype.clear = function () {
    ...
    if (!this.explicitlyCleared) {
      var t = this.doc.cm,
        r = t && !t.curOp;
      if ((r && Hn(t), lt(this, "clear"))) {
        var n = this.find();
        n && lr(this, "clear", n.from, n.to);
      }
      for (var i = null, o = null, a = 0; a < this.lines.length; ++a) {
        ...
        t && !e.collapsed
          ? Zn(t, fe(l), "text")
          : t && (null != s.to && (o = fe(l)), null != s.from && (i = fe(l))),
          (l.markedSpans = Ne(l.markedSpans, s)),
          null == s.from &&
            e.collapsed &&
            !Ke(e.doc, l) &&
            t &&
      ...
      null != i && t && this.collapsed && Yn(t, i, o + 1),
        (this.lines.length = 0),
        (this.explicitlyCleared = !0),
        this.atomic &&
          this.doc.cantEdit &&
          ((this.doc.cantEdit = !1), t && Yi(t.doc)),
        t && lr(t, "markerCleared", t, this, i, o),
        r && Rn(t),
    ...
    (bo.prototype.find = function (e, t) {
      ...
      for (var i = 0; i < this.lines.length; ++i) {
        ...
        if (null != a.from && ((r = ge(t ? o : fe(o), a.from)), -1 == e))
          return r;
        if (null != a.to && ((n = ge(t ? o : fe(o), a.to)), 1 == e)) return n;
      }
    ...
    (bo.prototype.changed = function () {
      ...
      a &&
        ...
        Vn(s, function () {
          ...
          if (
            (r &&
              (Pr(r), (s.curOp.selectionChanged = s.curOp.forceUpdate = !0)),
            (s.curOp.updateMaxLine = !0),
            !Ke(l.doc, e) && null != l.height)
          ) {
            var n = l.height;
            l.height = null;
            var i = br(l) - n;
  ...
  function ko(e) {
    return e.findMarks(ge(e.first, 0), e.clipPos(ge(e.lastLine())), function (
      e
    ) {
      return e.parent;
    });
    ...
    for (
      var e = function (e) {
          ...
          for (var n = 0; n < t.markers.length; n++) {
            var i = t.markers[n];
            -1 == H(r, i.doc) && ((i.parent = null), t.markers.splice(n--, 1));
          }
        },
        t = 0;
      t < o.length;
  ...
  var Co = 0,
    So = function (e, t, r, n, i) {
      if (!(this instanceof So)) return new So(e, t, r, n, i);
      null == r && (r = 0),
        mo.call(this, [new po([new $t("", null)])]),
        (this.first = r),
      ...
      (this.sel = bi(o)),
        ...
        Li(this, { from: o, to: o, text: e }),
        $i(this, bi(o), j);
    };
  (So.prototype = Q(mo.prototype, {
    constructor: So,
    iter: function (e, t, r) {
      r
    ...
    setValue: Xn(function (e) {
      ...
      no(
        ...
        this.cm && Tn(this.cm, 0, 0),
        $i(this, bi(t), j);
    }),
    replaceRange: function (e, t, r, n) {
      so(this, e, (t = _e(this, t)), (r = r ? _e(this, r) : t), n);
    },
    getRange: function (e, t, r) {
      var n = ce(this, _e(this, e), _e(this, t));
    ...
    setCursor: Xn(function (e, t, r) {
      Ki(this, _e(this, "number" == typeof e ? ge(e, t || 0) : e), null, r);
    }),
    setSelection: Xn(function (e, t, r) {
      Ki(this, _e(this, e), _e(this, t || e), r);
    }),
    extendSelection: Xn(function (e, t, r) {
      Bi(this, _e(this, e), t && _e(this, t), r);
    }),
    extendSelections: Xn(function (e, t) {
      ji(this, Ce(this, e), t);
    }),
    extendSelectionsBy: Xn(function (e, t) {
      ji(this, Ce(this, Y(this.sel.ranges, e)), t);
    }),
    setSelections: Xn(function (e, t, r) {
      if (e.length) {
        for (var n = [], i = 0; i < e.length; i++)
          n[i] = new vi(_e(this, e[i].anchor), _e(this, e[i].head));
        null == t && (t = Math.min(e.length - 1, this.sel.primIndex)),
          $i(this, yi(this.cm, n, t), r);
      }
    }),
    addSelection: Xn(function (e, t, r) {
      var n = this.sel.ranges.slice(0);
      n.push(new vi(_e(this, e), _e(this, t || e))),
        $i(this, yi(this.cm, n, n.length - 1), r);
    }),
    ...
    replaceSelections: Xn(function (e, t, r) {
      ...
      for (
        ...
        no(this, n[s]);
      l ? Vi(this, l) : this.cm && Sn(this.cm);
    }),
    undo: Xn(function () {
      oo(this, "undo");
    }),
    ...
    getHistory: function () {
      return { done: Hi(this.history.done), undone: Hi(this.history.undone) };
    },
    ...
    addLineClass: Xn(function (e, r, n) {
      return ho(this, e, "gutter" == r ? "gutter" : "class", function (e) {
        var t =
          "text" == r
            ...
            : "wrapClass";
        if (e[t]) {
          if (C(n).test(e[t])) return !1;
          e[t] += " " + n;
        } else e[t] = n;
        return !0;
      });
    }),
    removeLineClass: Xn(function (e, o, a) {
    ...
    addLineWidget: Xn(function (e, t, r) {
      return (
        (i = e),
        (o = new go((n = this), t, r)),
        (a = n.cm) && o.noHScroll && (a.display.alignWidgets = !0),
        ho(n, i, "widget", function (e) {
        ...
        a && lr(a, "lineWidgetAdded", a, o, "number" == typeof i ? i : fe(i)),
        o
      );
      var n, i, o, a;
    }),
    ...
    markText: function (e, t, r) {
      return wo(this, _e(this, e), _e(this, t), r, (r && r.type) || "range");
    },
    setBookmark: function (e, t) {
      ...
      return wo(this, (e = _e(this, e)), e, r, "bookmark");
    },
    findMarksAt: function (e) {
      var t = [],
        r = se(this, (e = _e(this, e)).line).markedSpans;
      if (r)
        for (var n = 0; n < r.length; ++n) {
          var i = r[n];
        ...
        this.iter(i.line, o.line + 1, function (e) {
          ...
          if (t)
            for (var r = 0; r < t.length; r++) {
              var n = t[r];
              (null != n.to && s == i.line && i.ch >= n.to) ||
                (null == n.from && s != i.line) ||
                (null != n.from && s == o.line && n.from >= o.ch) ||
                (a && !a(n.marker)) ||
                l.push(n.marker.parent || n.marker);
            }
          ++s;
        }),
        l
    ...
    copy: function (e) {
      var t = new So(
        ue(this, this.first, this.first + this.size),
        this.modeOption,
        this.first,
        this.lineSep,
        this.direction
    ...
    unlinkDoc: function (e) {
      if ((e instanceof ka && (e = e.doc), this.linked))
        for (var t = 0; t < this.linked.length; ++t) {
          if (this.linked[t].doc == e) {
            this.linked.splice(t, 1), e.unlinkDoc(this), _o(ko(this));
            break;
          }
        }
      if (e.history == this.history) {
        ...
        Mi(
          ...
          (e.history = new Oi(null)),
          (e.history.done = Hi(this.history.done, r)),
          (e.history.undone = Hi(this.history.undone, r));
      }
    },
    ...
    (So.prototype.eachLine = So.prototype.iter);
  var To = 0;
  function Lo(e) {
    var i = this;
    if ((Mo(i), !ot(i, e) && !wr(i.display, e))) {
      ct(e), x && (To = +new Date());
      var o = an(i, e, !0),
            ...
            var a = t.length,
              ...
              r = function (e, r) {
                if (
                  ...
                  -1 != H(i.options.allowDropFileTypes, e.type)
                ) {
                  var n = new FileReader();
                  (n.onload = $n(i, function () {
                    var e = n.result;
                    if (
          ...
          try {
            ...
            if (c) {
              ...
              if (
                ...
                for (var d = 0; d < u.length; ++d)
                  so(i.doc, "", u[d].anchor, u[d].head, "drag");
  ...
  for (
    ...
    zo[Fo + 48] = zo[Fo + 96] = String(Fo);
  for (var Io = 65; Io <= 90; Io++) zo[Io] = String.fromCharCode(Io);
  for (var Po = 1; Po <= 12; Po++) zo[Po + 111] = zo[Po + 63235] = "F" + Po;
  var Eo = {};
  function qo(e) {
    var t,
      r,
  ...
  function Wo(e) {
    ...
    for (var r in e)
      if (e.hasOwnProperty(r)) {
        ...
        for (var i = Y(r.split(" "), qo), o = 0; o < i.length; o++) {
          var a = void 0,
            l = void 0;
          o == i.length - 1
            ? ((l = i.join(" ")), (a = n))
  ...
  function Ho(e, t, r, n) {
    var i = (t = Uo(t)).call ? t.call(e, n) : t[e];
  ...
  function Uo(e) {
    return "string" == typeof e ? Eo[e] : e;
  }
  function Ko(t, e) {
    for (var r = t.doc.sel.ranges, n = [], i = 0; i < r.length; i++) {
      for (var o = e(r[i]); n.length && ve(o.from, X(n).to) <= 0; ) {
        var a = n.pop();
    ...
    Vn(t, function () {
      for (var e = n.length - 1; 0 <= e; e--)
        so(t.doc, "", n[e].from, n[e].to, "+delete");
      Sn(t);
    });
  }
  function Vo(e, t, r) {
  ...
  (Eo.basic = {
    ...
    (Eo.default = w ? Eo.macDefault : Eo.pcDefault);
  var Xo = {
    selectAll: to,
    ...
    killLine: function (r) {
      return Ko(r, function (e) {
        if (e.empty()) {
          var t = se(r.doc, e.head.line).text.length;
          return e.head.ch == t && e.head.line < r.lastLine()
            ? { from: e.head, to: ge(e.head.line + 1, 0) }
            : { from: e.head, to: ge(e.head.line, t) };
        }
    ...
    transposeChars: function (a) {
      return Vn(a, function () {
        for (var e = a.listSelections(), t = [], r = 0; r < e.length; r++)
          if (e[r].empty()) {
            var n = e[r].head,
              i = se(a.doc, n.line).text;
            if (i)
              if (
                (n.ch == i.length && (n = new ge(n.line, n.ch - 1)), 0 < n.ch)
              )
                (n = new ge(n.line, n.ch + 1)),
                  a.replaceRange(
              ...
              else if (n.line > a.doc.first) {
                var o = se(a.doc, n.line - 1).text;
                o &&
                  ((n = new ge(n.line, 1)),
                  a.replaceRange(
                    i.charAt(0) +
  ...
  function Yo(e, t) {
    var r = se(e.doc, t),
      n = Be(r);
    return n != r && (t = fe(n)), Go(!0, e, n, t, 1);
  }
  function Zo(e, t) {
    var r = Yo(e, t.line),
      n = se(e.doc, r.line),
  ...
  function ia(e) {
    ...
    if (((t.curOp.focus = D()), !ot(t, e))) {
      x && k < 11 && 27 == e.keyCode && (e.returnValue = !1);
      var r = e.keyCode;
  ...
  function aa(e) {
    ...
    if (
      ...
      var r = e.keyCode,
        n = e.charCode;
      if (g && r == na) return (na = null), void ct(e);
      if (!g || (e.which && !(e.which < 10)) || !ra(t, e)) {
        var i,
          o = String.fromCharCode(null == n ? r : n);
        if ("\b" != o)
          if (
            !ea((i = t), "'" + o + "'", e, function (e) {
              return Qo(i, e, !0);
            })
          )
          ...
          s = a
            ? ((n = a),
              ...
              sa && sa.compare(o, n, i)
                ? ((la = sa = null), "triple")
                : la && la.compare(o, n, i)
                ? ((sa = new ca(o, n, i)), (la = null), "double")
                : ((la = new ca(o, n, i)), (sa = null), "single"))
            : "single";
        window.focus(),
          1 == l && t.state.selectingText && t.state.selectingText(e),
          (a &&
            (function (r, e, n, t, i) {
              var o = "Click";
              "double" == t
            ...
            (1 == l
              ? a
                ? (function (e, t, r, n) {
                    x ? setTimeout(P(pn, e), 0) : (e.curOp.focus = D());
                    var i,
                      o = (function (e, t, r) {
                        var n = e.getOption("configureMouse"),
                          i = n ? n(e, t, r) : {};
                        if (null == i.unit) {
                          var o = h ? r.shiftKey && r.metaKey : r.altKey;
                          i.unit = o
                            ? "rectangle"
                            : "single" == t
                            ? "char"
                    ...
                    "single" == r &&
                    -1 < (i = a.contains(t)) &&
                    (ve((i = a.ranges[i]).from(), t) < 0 || 0 < t.xRel) &&
                    (0 < ve(i.to(), t) || t.xRel < 0)
                      ? (function (t, r, n, i) {
                          var o = t.display,
                            a = !1,
                            l = $n(t, function (e) {
                              b && (o.scroller.draggable = !1),
                                ...
                                nt(o.wrapper.ownerDocument, "mouseup", l),
                                nt(o.wrapper.ownerDocument, "mousemove", s),
                                nt(o.scroller, "dragstart", c),
                                nt(o.scroller, "drop", l),
                                a ||
                                  (ct(e),
                                  i.addNew ||
                                    Bi(t.doc, n, null, null, i.extend),
                                  b || (x && 9 == k)
                                    ? setTimeout(function () {
                          ...
                          ((t.state.draggingText = l).copy = !i.moveOnDrag),
                            o.scroller.dragDrop && o.scroller.dragDrop();
                          tt(o.wrapper.ownerDocument, "mouseup", l),
                            tt(o.wrapper.ownerDocument, "mousemove", s),
                            tt(o.scroller, "dragstart", c),
                            tt(o.scroller, "drop", l),
                            mn(t),
                            setTimeout(function () {
                      ...
                      : (function (g, e, v, y) {
                          ...
                          y.addNew && !y.extend
                            ? ((x = b.sel.contains(v)),
                              (w = -1 < x ? t[x] : new vi(v, v)))
                            : ((w = b.sel.primary()), (x = b.sel.primIndex));
                          if ("rectangle" == y.unit)
                            y.addNew || (w = new vi(v, v)),
                              (v = an(g, e, !0, !0)),
                              (x = -1);
                          else {
                            var r = da(g, v, y.unit);
                            w = y.extend
                              ? Ri(w, r.anchor, r.head, y.extend)
                              : r;
                          }
                          y.addNew
                            ? -1 == x
                              ? ((x = t.length),
                                $i(b, yi(g, t.concat([w]), x), {
                                  scroll: !1,
                                  origin: "*mouse",
                                }))
                              : 1 < t.length &&
                              ...
                              ? ($i(
                                ...
                                (k = b.sel))
                              : Ui(b, x, w, U)
                            : ($i(b, new gi([w], (x = 0)), U), (k = b.sel));
                          var _ = v;
                          function l(e) {
                            if (0 != ve(_, e))
                              if (((_ = e), "rectangle" == y.unit)) {
                                for (
                                  var t = [],
                                    r = g.options.tabSize,
                                    n = q(se(b, v.line).text, v.ch, r),
                                    i = q(se(b, e.line).text, e.ch, r),
                                    o = Math.min(n, i),
                                    a = Math.max(n, i),
                                    l = Math.min(v.line, e.line),
                                    s = Math.min(
                                      g.lastLine(),
                                      Math.max(v.line, e.line)
                                    );
                                  l <= s;
                                  l++
                                ) {
                                  var c = se(b, l).text,
                                    u = V(c, o, r);
                                  o == a
                                    ? t.push(new vi(ge(l, u), ge(l, u)))
                                    : c.length > u &&
                                      t.push(
                                        new vi(ge(l, u), ge(l, V(c, a, r)))
                                      );
                                }
                                t.length || t.push(new vi(v, v)),
                                  $i(
                                    b,
                                    yi(g, k.ranges.slice(0, x).concat(t), x),
                                ...
                                var d,
                                  ...
                                  p = f.anchor;
                                0 < ve(h.anchor, p)
                                  ? ((d = h.head), (p = xe(f.from(), h.anchor)))
                                  : ((d = h.anchor), (p = we(f.to(), h.head)));
                                var m = k.ranges.slice(0);
                                (m[x] = (function (e, t) {
                                  var r = t.anchor,
                                    n = t.head,
                                    i = se(e.doc, r.line);
                                  if (0 == ve(r, n) && r.sticky == n.sticky)
                                    return t;
                                  var o = Je(i);
                                  if (!o) return t;
                                  var a = Ze(o, r.ch, r.sticky),
                                    l = o[a];
                                  ...
                                  if (n.line != r.line)
                                    ...
                                    var u = Ze(o, n.ch, n.sticky),
                                      d =
                                        u - a ||
                                        (n.ch - r.ch) * (1 == l.level ? -1 : 1);
                                    s = u == c - 1 || u == c ? d < 0 : 0 < d;
                                  }
                                  var f = o[c + (s ? -1 : 0)],
                                    h = s == (1 == f.level),
                          ...
                          function n(e) {
                            (g.state.selectingText = !1),
                              ...
                              ct(e),
                              a.input.focus(),
                              nt(a.wrapper.ownerDocument, "mousemove", i),
                              nt(a.wrapper.ownerDocument, "mouseup", o),
                          ...
                          var i = $n(g, function (e) {
                              0 !== e.buttons && pt(e)
                                ? (function e(t) {
                                    var r = ++c;
                                    var n = an(g, t, !0, "rectangle" == y.unit);
                                    if (!n) return;
                                    if (0 != ve(n, _)) {
                                      (g.curOp.focus = D()), l(n);
                                      var i = wn(a, b);
                            ...
                            o = $n(g, n);
                          (g.state.selectingText = o),
                            tt(a.wrapper.ownerDocument, "mousemove", i),
                            tt(a.wrapper.ownerDocument, "mouseup", o);
                        })(e, n, t, o);
                  })(t, a, s, e)
                : ht(e) == r.scroller && ct(e)
              : 2 == l
              ? (a && Bi(t.doc, a),
                setTimeout(function () {
                  return r.input.focus();
                }, 20))
              : 3 == l && (_ ? t.display.input.onContextMenu(e) : mn(t)));
      }
  }
  function da(e, t, r) {
    if ("char" == r) return new vi(t, t);
    if ("word" == r) return e.findWordAt(t);
    if ("line" == r) return new vi(ge(t.line, 0), _e(e.doc, ge(t.line + 1, 0)));
    var n = r(e, t);
  ...
  function fa(e, t, r, n) {
    ...
    for (var s = 0; s < e.options.gutters.length; ++s) {
      ...
      if (c && c.getBoundingClientRect().right >= i)
        return it(e, r, e, he(e.doc, o), e.options.gutters[s], t), dt(t);
    }
  }
  function ha(e, t) {
  ...
  ca.prototype.compare = function (e, t, r) {
    return this.time + 400 > e && 0 == ve(t, this.pos) && r == this.button;
  };
  var ga = {
      toString: function () {
  ...
  function xa(e) {
    e.options.lineWrapping
      ...
      : (T(e.display.wrapper, "CodeMirror-wrap"), Xe(e)),
      on(e),
      Yn(e),
      qr(e),
      setTimeout(function () {
  ...
  function ka(e, t) {
    ...
    (this.options = t = t ? E(t) : {}), E(va, t, !1), ui(t);
    var n = t.value;
    "string" == typeof n
      ? (n = new So(n, t.mode, null, t.lineSeparator, t.direction))
      : t.mode && (n.modeOption = t.mode),
      (this.doc = n);
    var i = new ka.inputStyles[t.inputStyle](this),
      o = (this.display = new le(e, n, i));
    for (var a in (ci((o.wrapper.CodeMirror = this)),
    ma(this),
    ...
    (function (i) {
      var o = i.display;
      tt(o.scroller, "mousedown", $n(i, ua)),
        tt(
          o.scroller,
          "dblclick",
          x && k < 11
            ? $n(i, function (e) {
                if (!ot(i, e)) {
                  var t = an(i, e);
                  if (t && !ha(i, e) && !wr(i.display, e)) {
                    ct(e);
                    var r = i.findWordAt(t);
                    Bi(i.doc, r.anchor, r.head);
                  }
                }
              })
            : function (e) {
      ...
      tt(o.scroller, "touchstart", function (e) {
        ...
        tt(o.scroller, "touchend", function (e) {
          ...
          if (
            ...
            (r =
              !t.prev || l(t, t.prev)
                ? new vi(n, n)
                : !t.prev.prev || l(t, t.prev.prev)
                ? i.findWordAt(n)
                : new vi(ge(n.line, 0), _e(i.doc, ge(n.line + 1, 0)))),
        ...
        tt(o.scroller, "touchcancel", a),
        tt(o.scroller, "scroll", function () {
          o.scroller.clientHeight &&
            (Nn(i, o.scroller.scrollTop),
            On(i, o.scroller.scrollLeft, !0),
            it(i, "scroll", i));
        }),
        ...
        (o.dragFunctions = {
          ...
          start: function (e) {
            return (function (e, t) {
              if (x && (!e.state.draggingText || +new Date() - To < 100)) ft(t);
              else if (
                !ot(e, t) &&
                !wr(e.display, t) &&
    ...
    (t.autofocus && !f) || this.hasFocus()
      ? setTimeout(P(gn, this), 20)
      : vn(this),
    ya))
      ya.hasOwnProperty(a) && ya[a](r, t[a], ga);
    kn(this), t.finishInit && t.finishInit(this);
    for (var l = 0; l < _a.length; ++l) _a[l](r);
    Rn(this),
      b &&
        t.lineWrapping &&
  ...
  function Ca(e, t, r, n) {
    var i,
      o = e.doc;
    null == r && (r = "add"),
      "smart" == r && (o.mode.indent ? (i = Wt(e, t).state) : (r = "prev"));
    ...
    if (n || /\S/.test(l.text)) {
      if (
        "smart" == r &&
        ((c = o.mode.indent(i, l.text.slice(u.length), l.text)) == B || 150 < c)
      ) {
        if (!n) return;
        r = "prev";
      }
    ...
    "prev" == r
      ? (c = t > o.first ? q(se(o, t - 1).text, null, a) : 0)
      : "add" == r
    ...
    if ((f < c && (d += G(c - f)), d != u))
      return (
        so(o, d, ge(t, 0), ge(t, u.length), "+input"), !(l.stateAfter = null)
      );
  ...
  function La(e, t, r, n, i) {
    ...
    if (l && 1 < n.ranges.length)
      if (Sa && Sa.text.join("\n") == t) {
        if (n.ranges.length % Sa.text.length == 0) {
          c = [];
          for (var u = 0; u < Sa.text.length; u++)
            c.push(o.splitLines(Sa.text[u]));
        }
      } else
    ...
    for (var d = n.ranges.length - 1; 0 <= d; d--) {
      var f = n.ranges[d],
        h = f.from(),
        p = f.to();
      f.empty() &&
        (r && 0 < r
          ...
          ? (p = ge(
              p.line,
              Math.min(se(o, p.line).text.length, p.ch + X(s).length)
            ))
          : l &&
            Sa &&
            Sa.lineWise &&
          ...
          if (o.electricChars) {
            for (var l = 0; l < o.electricChars.length; l++)
              if (-1 < t.indexOf(o.electricChars.charAt(l))) {
                a = Ca(e, i.head.line, "smart");
                break;
              }
          } else
            o.electricInput &&
              o.electricInput.test(
                se(e.doc, i.head.line).text.slice(0, i.head.ch)
              ) &&
              (a = Ca(e, i.head.line, "smart"));
  ...
  function Da() {
    ...
    return (
      ...
      u && (e.style.border = "1px solid black"),
      Oa(e),
      t
    );
  }
  function za(n, i, o, e, a) {
    var t = i,
      r = o,
      l = se(n, i.line);
    function s(e) {
      ...
      if (
        ...
        (t = a
          ? (function (t, r, l, e) {
              var s = Je(r, t.doc.direction);
              if (!s) return $o(r, l, e);
              l.ch >= r.text.length
                ? ((l.ch = r.text.length), (l.sticky = "before"))
                : l.ch <= 0 && ((l.ch = 0), (l.sticky = "after"));
              var n = Ze(s, l.ch, l.sticky),
                i = s[n];
              if (
                "ltr" == t.doc.direction &&
                i.level % 2 == 0 &&
                (0 < e ? i.to > l.ch : i.from < l.ch)
              )
                return $o(r, l, e);
              var o,
                c = function (e, t) {
                  return Vo(r, e instanceof ge ? e.ch : e, t);
                },
                a = function (e) {
                  return t.options.lineWrapping
                    ? ((o = o || Ar(t, r)), Yr(t, r, o, e))
                    : { begin: 0, end: r.text.length };
                },
                u = a("before" == l.sticky ? c(l, -1) : l.ch);
              if ("rtl" == t.doc.direction || 1 == i.level) {
                var d = (1 == i.level) == e < 0,
                  f = c(l, d ? 1 : -1);
                if (
                  null != f &&
                  (d ? f <= i.to && f <= u.end : f >= i.from && f >= u.begin)
                ) {
                  var h = d ? "before" : "after";
                  return new ge(l.line, f, h);
                }
              }
              var p = function (e, t, r) {
                  for (
                    var n = function (e, t) {
                      return t
                        ? new ge(l.line, c(e, 1), "before")
                        : new ge(l.line, e, "after");
                    };
                    0 <= e && e < s.length;
                    e += t
                  ) {
                    var i = s[e],
                      o = 0 < t == (1 != i.level),
                      a = o ? r.begin : c(r.end, -1);
                    if (i.from <= a && a < i.to) return n(a, o);
                    if (
                      ((a = o ? i.from : c(i.to, -1)),
                      r.begin <= a && a < r.end)
                    )
        ...
        if (
          ...
          (r = i.line + o) < n.first ||
          r >= n.first + n.size ||
          ((i = new ge(r, i.ch, i.sticky)), !(l = se(n, r)))
        )
          return !1;
        i = Go(a, n.cm, l, i.line, o);
      } else i = t;
      return !0;
    }
    if ("char" == e) s();
      ...
      for (
        var c = null,
          u = "group" == e,
          d = n.cm && n.cm.getHelper(i, "wordChars"),
          f = !0;
        !(o < 0) || s(!f);
        f = !1
      ) {
        var h = l.text.charAt(i.ch) || "\n",
          p = te(h, d)
            ? "w"
            : u && "\n" == h
            ? "n"
  ...
  function Fa(e, t, r, n) {
    ...
    if ("page" == n) {
      ...
      i = (0 < r ? t.bottom : t.top) + r * c;
    } else "line" == n && (i = 0 < r ? t.bottom + 3 : t.top - 3);
    for (; (o = Gr(e, l, i)).outside; ) {
  ...
  function qa(e, t, r) {
    ...
    if (t == e.display.lineDiv) {
      if (!(n = e.display.lineDiv.childNodes[r]))
        return Ea(e.clipPos(ge(e.display.viewTo - 1)), !0);
      (t = null), (r = 0);
    } else
  ...
  function Wa(c, e, t) {
    var r = c.text.firstChild,
      n = !1;
    if (!e || !O(r, e)) return Ea(ge(fe(c.line), 0), !0);
    if (e == r && ((n = !0), (e = r.childNodes[t]), (t = 0), !e)) {
      var i = c.rest ? X(c.rest) : c.line;
      return Ea(ge(fe(i), i.text.length), n);
    }
    ...
    function l(e, t, r) {
      for (var n = -1; n < (d ? d.length : 0); n++)
        for (var i = n < 0 ? u.map : d[n], o = 0; o < i.length; o += 3) {
          var a = i[o + 2];
          if (a == e || a == t) {
            var l = fe(n < 0 ? c.line : c.rest[n]),
              s = i[o] + r;
            return (r < 0 || a != e) && (s = i[o + (r ? 1 : 0)]), ge(l, s);
          }
        }
    }
    var s = l(o, a, t);
    if (s) return Ea(s, n);
    for (
      var f = a.nextSibling, h = o ? o.nodeValue.length - t : 0;
      f;
      f = f.nextSibling
    ) {
      if ((s = l(f, f.firstChild, 0))) return Ea(ge(s.line, s.ch - h), n);
      h += f.textContent.length;
    }
    for (var p = a.previousSibling, m = t; p; p = p.previousSibling) {
      if ((s = l(p, p.firstChild, -1))) return Ea(ge(s.line, s.ch + m), n);
  ...
  (Ia.prototype.init = function (e) {
    ...
    function r(e) {
      if (!ot(l, e)) {
        ...
        l.display.lineSpace.insertBefore(n, l.display.lineSpace.firstChild),
          (i.value = Sa.text.join("\n"));
        var o = document.activeElement;
        I(i),
          setTimeout(function () {
            l.display.lineSpace.removeChild(n),
              o.focus(),
              o == s && a.showPrimarySelection();
          }, 50);
      }
    }
    Oa(s, l.options.spellcheck),
      tt(s, "paste", function (e) {
        ot(l, e) ||
          Ma(e, l) ||
          (k <= 11 &&
            setTimeout(
      ...
      if (
        ...
        if (
          ...
          var l = t.display.view,
            s = (n.line >= t.display.viewFrom && Pa(t, n)) || {
              node: l[0].measure.map[2],
              offset: 0,
            },
            c = i.line < t.display.viewTo && Pa(t, i);
          if (!c) {
          ...
          if (s && c) {
            ...
            try {
              f = S(s.node, s.offset, c.offset, c.node);
            } catch (e) {}
            f &&
              (!m && t.state.focused
    ...
    (Ia.prototype.pollSelection = function () {
      if (
        ...
        if (!this.composing) {
          this.rememberSelection();
          var r = qa(t, e.anchorNode, e.anchorOffset),
            n = qa(t, e.focusNode, e.focusOffset);
          r &&
            n &&
            Vn(t, function () {
              $i(t.doc, bi(r, n), j),
    ...
    (Ia.prototype.pollContent = function () {
      ...
      if (
        (0 == a.ch &&
          a.line > n.firstLine() &&
          (a = ge(a.line - 1, se(n.doc, a.line - 1).length)),
      ...
      a.line == i.viewFrom || 0 == (e = ln(n, a.line))
        ? ((t = fe(i.view[0].line)), (r = i.view[0].node))
        : ((t = fe(i.view[e].line)), (r = i.view[e - 1].node.nextSibling));
      var s,
        c,
        u = ln(n, l.line);
      if (
      ...
      for (
        var d = n.doc.splitLines(
            (function (s, e, t, c, u) {
              ...
              function g(e) {
                if (1 == e.nodeType) {
                  ...
                  for (var a = 0; a < e.childNodes.length; a++)
                    g(e.childNodes[a]);
                  /^(pre|p)$/i.test(e.nodeName) && (h = !0), o && (d = !0);
                } else
                  3 == e.nodeType &&
                    m(
              ...
              for (; g(e), e != t; ) (e = e.nextSibling), (h = !1);
              return r;
            })(n, r, c, t, s)
          ),
          f = ce(n.doc, ge(t, 0), ge(s, se(n.doc, s).text.length));
        1 < d.length && 1 < f.length;
      ...
      var x = ge(t, h),
        k = ge(s, f.length ? X(f).length - p : 0);
      return 1 < d.length || d[0] || ve(x, k)
        ? (so(n.doc, d, x, k, "+input"), !0)
        : void 0;
    }),
  ...
  (ja.prototype.init = function (t) {
    ...
    t.wrapper.insertBefore(this.wrapper, t.wrapper.firstChild),
      u && (i.style.width = "0px"),
      tt(i, "input", function () {
        x && 9 <= k && e.hasSelection && (e.hasSelection = null), r.poll();
      }),
      tt(i, "paste", function (e) {
        ot(n, e) || Ma(e, n) || ((n.state.pasteIncoming = !0), r.fastPoll());
      }),
      tt(i, "cut", o),
      tt(i, "copy", o),
      tt(t.scroller, "paste", function (e) {
        wr(t, e) || ot(n, e) || ((n.state.pasteIncoming = !0), r.focus());
      }),
      tt(t.lineSpace, "selectstart", function (e) {
        wr(t, e) || ct(e);
      }),
      ...
      if (!this.contextMenuPending && !this.composing) {
        ...
        if (t.somethingSelected()) {
          ...
          (this.textarea.value = r),
            ...
            x && 9 <= k && (this.hasSelection = r);
        } else
          e ||
            ((this.prevInput = this.textarea.value = ""),
            x && 9 <= k && (this.hasSelection = null));
      }
    }),
    ...
    (ja.prototype.onKeyPress = function () {
      x && 9 <= k && (this.hasSelection = null), this.fastPoll();
    }),
    (ja.prototype.onContextMenu = function (e) {
      ...
      if (t && !g) {
        n.options.resetSelectionOnContextMenu &&
          ...
          $n(n, $i)(n.doc, bi(t), j);
        var l = o.style.cssText,
          s = r.wrapper.style.cssText;
        r.wrapper.style.cssText = "position: absolute";
        var c,
          u = r.wrapper.getBoundingClientRect();
        if (
          ((o.style.cssText =
          ...
          ft(e);
          var d = function () {
            nt(window, "mouseup", d), setTimeout(h, 20);
          };
          tt(window, "mouseup", d);
      ...
      function h() {
        if (
          ...
          (r.wrapper.style.cssText = s),
          (o.style.cssText = l),
          x && k < 9 && i.scrollbars.setScrollTop((i.scroller.scrollTop = a)),
    ...
    (function (i) {
      ...
      (i.defineOption = e),
          ...
          if ((e.doc.lineSep = n)) {
            ...
            e.doc.iter(function (e) {
              for (var t = 0; ; ) {
                ...
                if (-1 == r) break;
                (t = r + n.length), i.push(ge(o, r));
              }
              o++;
            });
            for (var t = i.length - 1; 0 <= t; t--)
              so(e.doc, n, i[t], ge(i[t].line, i[t].ch + n.length));
          }
        }),
        e(
          "specialChars",
        ...
        e("cursorHeight", 1, sn, !0),
        e("singleCursorHeightPerLine", !0, sn, !0),
        e("workTime", 100),
        e("workDelay", 100),
        e("flattenSpans", !0, Si, !0),
        e("addModeClass", !1, Si, !0),
        e("pollInterval", 100),
        ...
        e("maxHighlightLength", 1e4, Si, !0),
        e("moveInputWithCursor", !0, function (e, t) {
    ...
    (Ha.prototype = {
      ...
      setOption: function (e, t) {
        ...
        (r[e] == t && "mode" != e) ||
          ((r[e] = t),
          Ra.hasOwnProperty(e) && $n(this, Ra[e])(this, t, n),
      ...
      indentSelection: Gn(function (e) {
        for (
          ...
          if (o.empty())
            o.head.line > n &&
              (Ca(t, o.head.line, e, !0),
              (n = o.head.line),
              i == t.doc.sel.primIndex && Sn(t));
          else {
            var a = o.from(),
              l = o.to(),
              s = Math.max(n, a.line);
            n = Math.min(t.lastLine(), l.line - (l.ch ? 0 : 1)) + 1;
            for (var c = s; c < n; ++c) Ca(t, c, e);
            var u = t.doc.sel.ranges;
            0 == a.ch &&
              r.length == u.length &&
              0 < u[i].from().ch &&
              Ui(t.doc, i, new vi(a, u[i].to()), j);
          }
        }
      }),
      ...
      getHelpers: function (e, t) {
        var r = [];
        if (!Ba.hasOwnProperty(t)) return r;
        var n = Ba[t],
          i = this.getModeAt(e);
        ...
        for (var l = 0; l < n._global.length; l++) {
          var s = n._global[l];
          s.pred(i, this) && -1 == H(r, s.val) && r.push(s.val);
        }
        return r;
      },
      getStateAfter: function (e, t) {
        ...
        return Wt(
          this,
          (e = ke(r, null == e ? r.first + r.size - 1 : e)) + 1,
          t
        ).state;
      },
      ...
      charCoords: function (e, t) {
        return Ur(this, _e(this.doc, e), t || "page");
      },
      coordsChar: function (e, t) {
        return Gr(this, (e = jr(this, e, t || "page")).left, e.top);
      },
      lineAtHeight: function (e, t) {
        return (
          (e = jr(this, { top: e, left: 0 }, t || "page").top),
      ...
      addWidget: function (e, t, r, n, i) {
        var o,
          ...
          l,
          s = this.display,
          c = (e = Kr(this, _e(this.doc, e))).bottom,
          u = e.left;
        if (
        ...
        (t.style.top = c + "px"),
          ...
          r &&
            ...
            null != (l = _n(o, a)).scrollTop && Nn(o, l.scrollTop),
      ...
      findPosH: function (e, t, r, n) {
        ...
        t < 0 && ((i = -1), (t = -t));
        for (
          var o = _e(this.doc, e), a = 0;
          a < t && !(o = za(this.doc, o, i, r, n)).hitSide;
          ++a
        );
        return o;
      },
      moveH: Gn(function (t, r) {
        var n = this;
        this.extendSelectionsBy(function (e) {
          return n.display.shift || n.doc.extend || e.empty()
            ? za(n.doc, e.head, t, r, n.options.rtlMoveVisually)
            : t < 0
            ? e.from()
            : e.to();
        }, K);
      }),
      deleteH: Gn(function (r, n) {
        var e = this.doc.sel,
          i = this.doc;
        e.somethingSelected()
          ? i.replaceSelection("", null, "+delete")
          : Ko(this, function (e) {
              var t = za(i, e.head, r, n, !1);
      ...
      findPosV: function (e, t, r, n) {
        var i = 1,
          o = n;
        t < 0 && ((i = -1), (t = -t));
        for (var a = _e(this.doc, e), l = 0; l < t; ++l) {
          var s = Kr(this, a, "div");
          if (
            (null == o ? (o = s.left) : (s.left = o),
            (a = Fa(this, s, i, r)).hitSide)
          )
            break;
        }
        return a;
      },
      moveV: Gn(function (n, i) {
        var o = this,
          a = this.doc,
          l = [],
          s = !this.display.shift && !a.extend && a.sel.somethingSelected();
        if (
          (a.extendSelectionsBy(function (e) {
            if (s) return n < 0 ? e.from() : e.to();
            var t = Kr(o, e.head, "div");
            null != e.goalColumn && (t.left = e.goalColumn), l.push(t.left);
            var r = Fa(o, t, n, i);
            return (
              "page" == i &&
                e == a.sel.primary() &&
                Cn(o, Ur(o, r, "div").top - t.top),
              r
            );
          }, K),
          l.length)
        )
          for (var e = 0; e < a.sel.ranges.length; e++)
            a.sel.ranges[e].goalColumn = l[e];
      }),
      findWordAt: function (e) {
        ...
        return new vi(ge(e.line, r), ge(e.line, n));
      },
      toggleOverwrite: function (e) {
      ...
      scrollIntoView: Gn(function (e, t) {
        ...
        null == e
          ...
          (e.margin = t || 0),
          null != e.from.line
            ? ((n = e), Ln((r = this)), (r.curOp.scrollToPos = n))
      ...
      refresh: Gn(function () {
        ...
        Yn(this),
          ...
          li(this),
          (null == e || 0.5 < Math.abs(e - Jr(this.display))) && on(this),
          it(this, "refresh", this);
      }),
    ...
    st(Ha),
    (Ha.registerHelper = function (e, t, r) {
      Ba.hasOwnProperty(e) || (Ba[e] = Ha[e] = { _global: [] }), (Ba[e][t] = r);
    }),
    (Ha.registerGlobalHelper = function (e, t, r, n) {
      Ha.registerHelper(e, t, n), Ba[e]._global.push({ pred: r, val: n });
    });
  var Ua,
    Ka = "iter insert remove copy getEditor constructor".split(" ");
  for (var Va in So.prototype)
    So.prototype.hasOwnProperty(Va) &&
      H(Ka, Va) < 0 &&
      (ka.prototype[Va] = (function (e) {
        return function () {
  ...
  return (
    st(So),
    (ka.inputStyles = { textarea: ja, contenteditable: Ia }),
    ...
    (ka.fromTextArea = function (t, e) {
      if (
        ...
        var r = D();
        e.autofocus =
          r == t || (null != t.getAttribute("autofocus") && r == document.body);
      }
      function n() {
        t.value = l.getValue();
      }
    ...
    (Ua.isModifierKey = Ro),
    (Ua.lookupKey = Ho),
    (Ua.normalizeKeyMap = Wo),
    (Ua.StringStream = Ft),
    (Ua.SharedTextMarker = xo),
    (Ua.TextMarker = bo),
    (Ua.LineWidget = go),
    (Ua.e_preventDefault = ct),
    (Ua.e_stopPropagation = ut),
    (Ua.e_stop = ft),
    (Ua.addClass = z),
    (Ua.contains = O),
    (Ua.rmClass = T),
  ...
  (function (e) {
    ...
    function n(o) {
      (o.state.failedTagMatch = !1),
        o.operation(function () {
          if ((l(o), !o.somethingSelected())) {
            var e = o.getCursor(),
              t = o.getViewport();
            (t.from = Math.min(t.from, e.line)),
              (t.to = Math.max(e.line + 1, t.to));
            var r = a.findMatchingTag(o, e, t);
            if (r) {
              if (o.state.matchBothTags) {
                var n = "open" == r.at ? r.open : r.close;
                n &&
                  (o.state.tagHit = o.markText(n.from, n.to, {
                    className: "CodeMirror-matchingtag",
                  }));
              }
              var i = "close" == r.at ? r.open : r.close;
              i
                ? (o.state.tagOther = o.markText(i.from, i.to, {
                    className: "CodeMirror-matchingtag",
                  }))
    ...
    a.defineOption("matchTags", !1, function (e, t, r) {
      r &&
        r != a.Init &&
        (e.off("cursorActivity", n), e.off("viewportChange", i), l(e)),
        t &&
          ((e.state.matchBothTags = "object" == typeof t && t.bothTags),
          e.on("cursorActivity", n),
          e.on("viewportChange", i),
          n(e));
    }),
      (a.commands.toMatchingTag = function (e) {
        var t = a.findMatchingTag(e, e.getCursor());
        if (t) {
          var r = "close" == t.at ? t.open : t.close;
          r && e.extendSelection(r.to, r.from);
        }
      });
  }),
  (function (e) {
    ...
    function o(t, e) {
      for (var r = [], n = 0; n < e.length; n++) {
        var i = e[n],
          o = t.getOption("styleActiveLine");
        if (
          "object" == typeof o && o.nonEmpty
            ? i.anchor.line == i.head.line
            : i.empty()
        ) {
          var a = t.getLineHandleVisualStart(i.head.line);
      ...
      (function (e, t) {
        ...
        return !0;
      })(t.state.activeLines, r) ||
        t.operation(function () {
          u(t);
          for (var e = 0; e < r.length; e++)
            t.addLineClass(r[e], "wrap", l),
              t.addLineClass(r[e], "background", s),
              t.addLineClass(r[e], "gutter", c);
          t.state.activeLines = r;
        });
    }
    function a(e, t) {
    ...
    i.defineOption("styleActiveLine", !1, function (e, t, r) {
      var n = r != i.Init && r;
      t != n &&
        (n &&
          (e.off("beforeSelectionChange", a), u(e), delete e.state.activeLines),
        t &&
          ((e.state.activeLines = []),
          o(e, e.listSelections()),
          e.on("beforeSelectionChange", a)));
    });
  }),
  (function (e) {
    "object" == typeof exports && "object" == typeof module
    ...
    function i(e, t) {
      var r = e.cm.getTokenTypeAt(s(e.line, t));
      ...
      for (;;) {
        ...
        if (i(e, t + 1)) {
          var r = e.text.lastIndexOf("/", t),
            n = -1 < r && !/\S/.test(e.text.slice(r + 1, t));
      ...
      for (var r = []; ; ) {
        ...
        if ("selfClose" != n)
          if (i[1]) {
            ...
            if (l < 0 && (!t || t == i[2]))
              return { tag: i[2], from: s(o, a), to: s(e.line, e.ch) };
          } else r.push(i[2]);
      }
    }
    function g(e, t) {
      for (var r = []; ; ) {
        ...
        if ("selfClose" != n) {
          ...
          if (a[1]) r.push(a[2]);
            ...
            if (l < 0 && (!t || t == a[2]))
              return { tag: a[2], from: s(e.line, e.ch), to: s(i, o) };
          }
        } else f(e);
      }
    }
    e.registerHelper("fold", "xml", function (e, t) {
      for (var r = new u(e, t.line, 0); ; ) {
        var n = h(r);
        if (!n || r.line != t.line) return;
        var i = d(r);
        if (!i) return;
        if (!n[1] && "selfClose" != i) {
          var o = s(r.line, r.ch),
            a = m(r, n[2]);
          return a && 0 < c(a.from, o) ? { from: o, to: a.from } : null;
        }
      }
    }),
      (e.findMatchingTag = function (e, t, r) {
        var n = new u(e, t.line, t.ch, r);
        if (-1 != n.text.indexOf(">") || -1 != n.text.indexOf("<")) {
          var i = d(n),
            o = i && s(n.line, n.ch),
            a = i && f(n);
          if (i && a && !(0 < c(n, t))) {
            var l = { from: s(n.line, n.ch), to: o, tag: a[2] };
            return "selfClose" == i
              ? { open: l, close: null, at: "open" }
              : a[1]
              ? { open: g(n, a[2]), close: l, at: "close" }
              : {
                  open: l,
                  close: m((n = new u(e, o.line, o.ch, r)), a[2]),
                  at: "open",
                };
          }
        }
      ...
      (e.findEnclosingTag = function (e, t, r, n) {
        for (var i = new u(e, t.line, t.ch, r); ; ) {
          var o = g(i, n);
          if (!o) break;
          var a = m(new u(e, t.line, t.ch, r), o.tag);
          if (a) return { open: o, close: a };
        }
      }),
      (e.scanForClosingTag = function (e, t, r, n) {
        return m(new u(e, t.line, t.ch, n ? { from: 0, to: n } : null), r);
      });
  }),
  (function (e) {
    "object" == typeof exports && "object" == typeof module
    ...
    function D(e, t, r, n) {
      ...
      return (
        e.context &&
          ...
          "statement" != r &&
          (i = e.context.indented),
        (e.context = new O(i, t, r, n, null, e.context))
      );
    }
    function z(e) {
    ...
    A.defineMode("clike", function (e, l) {
      var a,
        s,
        c = e.indentUnit,
        u = l.statementIndentUnit || c,
        d = l.dontAlignCalls,
        f = l.keywords || {},
        h = l.types || {},
        p = l.builtin || {},
        ...
        v = l.atoms || {},
        y = l.hooks || {},
        b = l.multiLineStrings,
        o = !1 !== l.indentStatements,
        t = !1 !== l.indentSwitch,
        w = l.namespaceSeparator,
        x = l.isPunctuationChar || /[\[\]{}\(\),;\:\.]/,
        k = l.numberStart || /[\d\.]/,
        _ =
          l.number ||
          /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
        C = l.isOperatorChar || /[+\-*&%=<>!?|\/]/,
        S = l.isIdentifierChar || /[\w\$_\xa1-\uffff]/,
        T = l.isReservedIdentifier || !1;
      function L(e, t) {
        var o,
          r = e.next();
        if (y[r]) {
        ...
        if ('"' == r || "'" == r)
          return (
            (t.tokenize =
              ((o = r),
              function (e, t) {
                for (var r, n = !1, i = !1; null != (r = e.next()); ) {
                  if (r == o && !n) {
                    i = !0;
                    break;
                  }
                ...
                return (i || (!n && !b)) && (t.tokenize = null), "string";
              })),
            t.tokenize(e, t)
          );
        if (x.test(r)) return (a = r), null;
        if (k.test(r)) {
          if ((e.backUp(1), e.match(_))) return "number";
          e.next();
        }
        if ("/" == r) {
          if (e.eat("*")) return (t.tokenize = M)(e, t);
          if (e.eat("/")) return e.skipToEnd(), "comment";
        }
        if (C.test(r)) {
          for (; !e.match(/^\/[\/*]/, !1) && e.eat(C); );
          return "operator";
        }
        if ((e.eatWhile(S), w)) for (; e.match(w); ) e.eatWhile(S);
        var i = e.current();
        return P(f, i)
          ? (P(m, i) && (a = "newstatement"), P(g, i) && (s = !0), "keyword")
          : P(h, i)
          ? "type"
          : P(p, i) || (T && T(i))
          ? (P(m, i) && (a = "newstatement"), "builtin")
          : P(v, i)
          ? "atom"
          : "variable";
      }
      ...
      function N(e, t) {
        l.typeFirstDefinitions &&
          e.eol() &&
          I(t.context) &&
          (t.typeAtEndOfLine = F(e, t, e.pos));
      }
      return {
        startState: function (e) {
          return {
            tokenize: null,
            context: new O((e || 0) - c, 0, "top", null, !1),
            indented: 0,
            startOfLine: !0,
            prevToken: null,
          };
        ...
        token: function (e, t) {
          ...
          if (
            ...
            for (; "statement" == t.context.type; ) z(t);
          else if ("{" == a) D(t, e.column(), "}");
          else if ("[" == a) D(t, e.column(), "]");
          else if ("(" == a) D(t, e.column(), ")");
          else if ("}" == a) {
            for (; "statement" == r.type; ) r = z(t);
            for ("}" == r.type && (r = z(t)); "statement" == r.type; ) r = z(t);
          } else
            a == r.type
              ? z(t)
              : o &&
                ((("}" == r.type || "top" == r.type) && ";" != a) ||
                  ("statement" == r.type && "newstatement" == a)) &&
                D(t, e.column(), "statement", e.current());
          if (
            ("variable" == n &&
              ("def" == t.prevToken ||
                (l.typeFirstDefinitions &&
          ...
          return (
            "def" == n && !1 === l.styleDefs && (n = "variable"),
            (t.startOfLine = !1),
            (t.prevToken = s ? "def" : n || a),
            N(e, t),
            n
          );
        },
        indent: function (e, t) {
          if ((e.tokenize != L && null != e.tokenize) || e.typeAtEndOfLine)
            return A.Pass;
          var r = e.context,
            n = t && t.charAt(0),
            i = n == r.type;
          if (
            ("statement" == r.type && "}" == n && (r = r.prev),
            ...
            for (
              ...
              r = r.prev;
          if (y.indent) {
            var o = y.indent(e, r, t, c);
            if ("number" == typeof o) return o;
          }
          var a = r.prev && "switch" == r.prev.info;
          if (l.allmanIndentation && /[{(]/.test(n)) {
    ...
    var t =
      ...
      r = e("int long char short double float unsigned signed void bool"),
      n = e("SEL instancetype id Class Protocol BOOL");
    function i(e) {
      return P(r, e) || /.+_t/.test(e);
    }
    ...
    function d(e, t) {
      if ((e.backUp(1), e.match(/(R|u8R|uR|UR|LR)/))) {
        ...
        return !!r && ((t.cpp11RawStringDelim = r[1]), (t.tokenize = h)(e, t));
      }
    ...
    function p(e, t) {
      ...
      n(t.keywords),
        ...
        n(t.atoms),
        r.length &&
          ((t.helperType = e[0]), A.registerHelper("hintWords", e[0], r));
      for (var i = 0; i < e.length; ++i) A.defineMIME(e[i], t);
    }
    function m(e, t) {
      for (var r = !1; !e.eol(); ) {
        if (!r && e.match('"""')) {
    ...
    p(["text/x-csrc", "text/x-c", "text/x-chdr"], {
      name: "clike",
      keywords: e(t),
      types: i,
      blockKeywords: e(o),
      ...
      p(["text/x-c++src", "text/x-c++hdr"], {
        ...
        types: i,
        blockKeywords: e(o + " class try catch"),
        defKeywords: e(a + " class namespace"),
        typeFirstDefinitions: !0,
                ...
                return function (e, t) {
                  for (var r; (r = e.next()); ) {
                    if ("*" == r && e.eat("/")) {
                      ...
                      return (t.tokenize = n(i - 1)), t.tokenize(e, t);
                    }
                    if ("/" == r && e.eat("*"))
                      return (t.tokenize = n(i + 1)), t.tokenize(e, t);
                  }
      ...
      p(["x-shader/x-vertex", "x-shader/x-fragment"], {
        name: "clike",
        keywords: e(
      ...
      p("text/x-objectivec", {
        ...
        blockKeywords: e(
          o + " @synthesize @try @catch @finally @autoreleasepool @synchronized"
        ),
        defKeywords: e(a + " @interface @implementation @protocol @class"),
    ...
    p("text/x-ceylon", {
      ...
      hooks: {
        ...
        '"': function (e, t) {
          return (
            (t.tokenize = (function o(a) {
              return function (e, t) {
                for (var r, n = !1, i = !1; !e.eol(); ) {
                  if (!n && e.match('"') && ("single" == a || e.match('""'))) {
                    i = !0;
                    break;
                  }
                  if (!n && e.match("``")) {
        ...
        "`": function (e, t) {
          return (
            !(!g || !e.match("`")) &&
            ((t.tokenize = g), (g = null), t.tokenize(e, t))
          );
        },
        "'": function (e) {
          return e.eatWhile(/[\w\$_\xa1-\uffff]/), "atom";
  ...
  (function (e) {
    ...
    A.defineMode("css", function (e, t) {
      var r = t.inline;
      t.propertyKeywords || (t = A.resolveMode("text/css"));
      var n,
        i,
        o = e.indentUnit,
        a = t.tokenHooks,
        ...
        s = t.mediaTypes || {},
        c = t.mediaFeatures || {},
        u = t.mediaValueKeywords || {},
        d = t.propertyKeywords || {},
        f = t.nonStandardPropertyKeywords || {},
        h = t.fontProperties || {},
        p = t.counterDescriptors || {},
        m = t.colorKeywords || {},
        g = t.valueKeywords || {},
        v = t.allowNested,
        y = t.lineComment,
        b = !0 === t.supportsAtComponent;
      function w(e, t) {
        return (n = t), e;
      }
      function x(i) {
      ...
      function L(e, t, r, n) {
        for (var i = n || 1; 0 < i; i--) r.context = r.context.prev;
        return T(e, t, r);
      }
      function M(e) {
        var t = e.current().toLowerCase();
        i = g.hasOwnProperty(t)
          ? "atom"
          : m.hasOwnProperty(t)
          ? "keyword"
          : "variable";
      ...
      var N = {
        top: function (e, t, r) {
          if ("{" == e) return C(r, t, "block");
          if ("}" == e && r.context.prev) return S(r);
          if (b && /@component/i.test(e)) return C(r, t, "atComponentBlock");
          if (/^@(-moz-)?document$/i.test(e)) return C(r, t, "documentTypes");
          if (/^@(media|supports|(-moz-)?document|import)$/i.test(e))
            return C(r, t, "atBlock");
          ...
          if (e && "@" == e.charAt(0)) return C(r, t, "at");
          if ("hash" == e) i = "builtin";
          else if ("word" == e) i = "tag";
          else {
            if ("variable-definition" == e) return "maybeprop";
            if ("interpolation" == e) return C(r, t, "interpolation");
            if (":" == e) return "pseudo";
            if (v && "(" == e) return C(r, t, "parens");
          }
        ...
        maybeprop: function (e, t, r) {
          return ":" == e ? C(r, t, "prop") : T(e, t, r);
        },
        prop: function (e, t, r) {
          if (";" == e) return S(r);
          if ("{" == e && v) return C(r, t, "propBlock");
          if ("}" == e || "{" == e) return L(e, t, r);
          if ("(" == e) return C(r, t, "parens");
          if (
            "hash" != e ||
            ...
            if ("word" == e) M(t);
            else if ("interpolation" == e) return C(r, t, "interpolation");
          } else i += " error";
          return "prop";
        },
        ...
        atBlock: function (e, t, r) {
          if ("(" == e) return C(r, t, "atBlock_parens");
          if ("}" == e || ";" == e) return L(e, t, r);
          if ("{" == e) return S(r) && C(r, t, v ? "block" : "top");
          if ("interpolation" == e) return C(r, t, "interpolation");
          if ("word" == e) {
            var n = t.current().toLowerCase();
            i =
      ...
      return {
        startState: function (e) {
          return {
            ...
            state: r ? "block" : "top",
            stateArg: null,
            context: new _(r ? "block" : "top", e || 0, null),
          };
        },
        token: function (e, t) {
            ...
            function (e, t) {
              ...
              return "@" == r
                ...
                ? /[,+>*\/]/.test(r)
                  ...
                  ? (e.backUp(1), (t.tokenize = k), w("property", "word"))
                  : /[\w\\\-]/.test(r)
          ...
          return (
            ...
            (i = r),
            "comment" != n && (t.state = N[t.state](n, e, t)),
            i
          );
        },
        indent: function (e, t) {
    ...
    A.registerHelper("hintWords", "css", b),
      A.defineMIME("text/css", {
        ...
        fontProperties: h,
        counterDescriptors: p,
        colorKeywords: g,
        valueKeywords: y,
        tokenHooks: {
          "/": function (e, t) {
            return !!e.eat("*") && (t.tokenize = w)(e, t);
          },
        },
        name: "css",
      }),
      ...
      function (u, e) {
        ...
        if ((a(i, f), t && a(t, f), r))
          for (var n = r.length - 1; 0 <= n; n--)
            f.script.unshift(["type", r[n].matches, r[n].mode]);
        function h(e, t) {
          var r,
            n = d.token(e, t.htmlState),
            i = /\btag\b/.test(n);
          if (
            i &&
            !/[<>\s\/]/.test(e.current()) &&
            (r = t.htmlState.tagName && t.htmlState.tagName.toLowerCase()) &&
            f.hasOwnProperty(r)
          )
            t.inTag = r + " ";
            ...
            var a =
                ...
                (function (e, t) {
                  for (var r = 0; r < e.length; r++) {
                    var n = e[r];
                    if (!n[0] || n[1].test(m(t, n[0]))) return n[2];
                  }
                })(f[o[1]], o[2]),
              l = p.getMode(u, a),
              s = g(o[1], !0),
            ...
            (t.token = function (e, t) {
              return e.match(s, !1)
                ? ((t.token = h), (t.localState = t.localMode = null), null)
                : ((r = e),
                  (n = c),
                  ...
                  -1 < (a = o.search(n))
                    ? r.backUp(o.length - a)
                    : o.match(/<\/?$/) &&
                      (r.backUp(o.length), r.match(n, !1) || r.match(o)),
                  i);
              var r, n, i, o, a;
            }),
              (t.localMode = l),
              (t.localState = p.startState(l, d.indent(t.htmlState, "")));
          } else
            t.inTag && ((t.inTag += e.current()), e.eol() && (t.inTag += " "));
          return n;
        }
        return {
          startState: function () {
            return {
              ...
              localMode: null,
              localState: null,
              htmlState: p.startState(d),
            };
          },
          copyState: function (e) {
            var t;
            return (
              e.localState && (t = p.copyState(e.localMode, e.localState)),
              {
                token: e.token,
                inTag: e.inTag,
                localMode: e.localMode,
                localState: t,
                htmlState: p.copyState(d, e.htmlState),
              }
            );
          },
          token: function (e, t) {
          ...
          indent: function (e, t, r) {
            return !e.localMode || /^\s*<\//.test(t)
              ? d.indent(e.htmlState, t)
              : e.localMode.indent
              ? e.localMode.indent(e.localState, t, r)
              : p.Pass;
          },
  ...
  (function (e) {
    ...
    "use strict";
    $e.defineMode("javascript", function (e, d) {
      var n,
        i,
        f = e.indentUnit,
        h = d.statementIndent,
          ...
          return (
            (t.tokenize =
              ...
              function (e, t) {
                var r,
                  n = !1;
                if (a && "@" == e.peek() && e.match(m))
                  return (t.tokenize = v), g("jsonld-keyword", "meta");
                for (; null != (r = e.next()) && (r != i || n); )
                  n = !n && "\\" == r;
                return n || (t.tokenize = v), g("string", "string");
              })),
            t.tokenize(e, t)
          );
        if ("." == r && e.match(/^\d+(?:[eE][+\-]?\d+)?/))
            ...
            var r = (function e(t, r) {
              {
                if (r) {
                  if (r.block) {
                    var n = e(t, r.prev);
                    return n ? (n == r.prev ? r : new N(n, r.vars, !0)) : null;
                  }
                  return L(t, r.vars) ? r : new N(r.prev, new A(t, r.vars), !1);
                }
                return null;
              }
            })(e, t.context);
      ...
      var t = new A("this", new A("arguments", null));
      function O() {
        ...
        var e = function () {
          ...
          if ("stat" == e.lexical.type) t = e.lexical.indented;
            ...
            for (var r = e.lexical; r && ")" == r.type && r.align; r = r.prev)
              t = r.indented;
          e.lexical = new k(t, C.stream.column(), n, null, e.lexical, i);
        };
        return (e.lex = !0), e;
      }
      function I() {
      ...
      function E(e, t) {
        return "var" == e
          ...
          ? ((C.marked = "keyword"), T(F("form"), De, I))
          : "variable" == e
          ? c && "declare" == t
            ? ((C.marked = "keyword"), T(E))
            : c &&
            ...
            ? ((C.marked = "keyword"),
              "enum" == t
                ? T(Ue)
                : "type" == t
                ? T(ce, P("operator"), ce, P(";"))
                : T(F("form"), ye, P("{"), F("}"), oe, I, I))
            : c && "namespace" == t
            ? ((C.marked = "keyword"), T(F("form"), W, oe, I))
            : c && "abstract" == t
            ? ((C.marked = "keyword"), T(E))
            : T(F("stat"), Q)
          : "switch" == e
          ? T(F("form"), R, P("{"), F("}", "switch"), D, oe, I, I, z)
          : "case" == e
          ? T(W, P(":"))
          : "default" == e
          ? T(P(":"))
      ...
      function R(e) {
        return "(" != e ? S() : T(F(")"), W, P(")"), I);
      }
      function B(e, t, r) {
        if (C.state.fatArrowAt == C.stream.start) {
          var n = r ? X : G;
          if ("(" == e) return T(O, F(")"), ne(Ae, ")"), I, P("=>"), n, z);
          if ("variable" == e) return S(O, ye, P("=>"), n, z);
        }
        var i,
          o = r ? K : U;
        return x.hasOwnProperty(e)
          ...
          ? T(Ne, o)
          : "class" == e || (c && "interface" == t)
          ? ((C.marked = "keyword"), T(F("form"), Oe, I))
          : "keyword c" == e || "async" == e
          ? T(r ? H : W)
          : "(" == e
          ? T(F(")"), j, P(")"), I, o)
      ...
      function $(e) {
        if ("}" == e)
          return (C.marked = "string-2"), (C.state.tokenize = b), T(V);
      }
      function G(e) {
        return o(C.stream, C.state), S("{" == e ? E : W);
      }
      function X(e) {
        return o(C.stream, C.state), S("{" == e ? E : H);
      }
      function Y(e, t) {
        if ("target" == t) return (C.marked = "keyword"), T(U);
      }
      function Z(e, t) {
        if ("target" == t) return (C.marked = "keyword"), T(K);
      }
      function Q(e) {
        return ":" == e ? T(I, E) : S(U, P(";"), I);
      }
      function J(e) {
        if ("variable" == e) return (C.marked = "property"), T();
      }
      function ee(e, t) {
        if ("async" == e) return (C.marked = "property"), T(ee);
        if ("variable" == e || "keyword" == C.style) {
          ...
          if ("number" == e || "string" == e)
            return (C.marked = a ? "property" : C.style + " property"), T(re);
          if ("jsonld-keyword" == e) return T(re);
          if (c && M(t)) return (C.marked = "keyword"), T(ee);
          if ("[" == e) return T(W, ae, P("]"), re);
          if ("spread" == e) return T(H, re);
      ...
      function re(e) {
        return ":" == e ? T(H) : "(" == e ? S(Ne) : void 0;
      }
      function ne(n, i, o) {
        function a(e, t) {
          if (o ? -1 < o.indexOf(e) : "," == e) {
            var r = C.state.lexical;
            return (
              "call" == r.info && (r.pos = (r.pos || 0) + 1),
              T(function (e, t) {
                return e == i || t == i ? S() : S(n);
              }, a)
            );
          }
          return e == i || t == i ? T() : T(P(i));
        }
        return function (e, t) {
          return e == i || t == i ? T() : S(n, a);
        };
      }
      function ie(e, t, r) {
        for (var n = 3; n < arguments.length; n++) C.cc.push(arguments[n]);
        return T(F(t, r), ne(e, t), I);
      }
      function oe(e) {
        return "}" == e ? T() : S(E, oe);
      }
      ...
      function le(e) {
        if (c && ":" == e)
          return C.stream.match(/^\s*\w+\s+is\b/, !1) ? T(W, se, ce) : T(ce);
      }
      function se(e, t) {
      ...
      function ce(e, t) {
        return "keyof" == t || "typeof" == t
          ? ((C.marked = "keyword"), T("keyof" == t ? ce : H))
          : "variable" == e || "void" == t
          ? ((C.marked = "type"), T(he))
      ...
      function ve(e, t) {
        return "enum" == t
          ? ((C.marked = "keyword"), T(Ue))
          : S(ye, ae, xe, ke);
      }
      function ye(e, t) {
        return c && M(t)
          ? ((C.marked = "keyword"), T(ye))
          : "variable" == e
          ? (r(t), T())
          : "spread" == e
          ? T(ye)
      ...
      function _e(e, t) {
        if ("keyword b" == e && "else" == t) return T(F("form", "else"), E, I);
      }
      function Ce(e, t) {
        return "await" == t
          ? T(Ce)
      ...
      function Ae(e, t) {
        return (
          ...
          "spread" == e
            ? T(Ae)
            : c && M(t)
            ? ((C.marked = "keyword"), T(Ae))
            : S(ye, ae, xe)
        );
      }
      function Oe(e, t) {
        return "variable" == e ? De(e, t) : ze(e, t);
      }
      function De(e, t) {
        if ("variable" == e) return r(t), T(ze);
      }
      function ze(e, t) {
        return "<" == t
          ? T(F(">"), ne(me, ">"), I, ze)
          : "extends" == t || "implements" == t || (c && "," == e)
          ? ("implements" == t && (C.marked = "keyword"), T(c ? ce : W, ze))
          : "{" == e
          ? T(F("}"), Fe, I)
          : void 0;
      }
      ...
      function Pe(e, t) {
        return "*" == t
          ? ((C.marked = "keyword"), T(Be, P(";")))
          : "default" == t
          ? ((C.marked = "keyword"), T(W, P(";")))
          : "{" == e
          ? T(ne(Ee, "}"), Be, P(";"))
          : S(E);
      }
      function Ee(e, t) {
        return "as" == t
          ? ((C.marked = "keyword"), T(P("variable")))
          : "variable" == e
          ? S(H, Ee)
          : void 0;
      }
      function qe(e) {
        return "string" == e ? T() : "(" == e ? S(W) : S(We, He, Be);
      }
      function We(e, t) {
        return "{" == e
          ? ie(We, "}")
      ...
      function Re(e, t) {
        if ("as" == t) return (C.marked = "keyword"), T(We);
      }
      function Be(e, t) {
        if ("from" == t) return (C.marked = "keyword"), T(W);
      }
      function je(e) {
        return "]" == e ? T() : S(ne(H, "]"));
      }
      function Ue() {
        return S(F("form"), ye, P("{"), F("}"), ne(Ke, "}"), I, I);
      }
      function Ke() {
        return S(ye, xe);
      }
        ...
        (I.lex = z.lex = !0),
        {
          startState: function (e) {
            var t = {
              ...
              lastType: "sof",
              cc: [],
              lexical: new k((e || 0) - f, 0, "block", !1),
              localVars: d.localVars,
              context: d.localVars && new N(null, null, !1),
              indented: e || 0,
            };
            return (
              d.globalVars &&
                "object" == typeof d.globalVars &&
                (t.globalVars = d.globalVars),
              t
            );
          },
          token: function (e, t) {
          ...
          indent: function (e, t) {
            ...
            for (
              ...
              i = i.prev;
            h && ")" == i.type && "stat" == i.prev.type && (i = i.prev);
            var l,
              s,
              c = i.type,
              u = n == c;
            return "vardef" == c
              ...
              ? i.indented +
                ((s = t),
                "operator" == (l = e).lastType ||
                "," == l.lastType ||
                p.test(s.charAt(0)) ||
                /[,.]/.test(s.charAt(0))
                  ? h || f
                  : 0)
              : "switch" != i.info || u || 0 == d.doubleIndentSwitch
              ? i.align
                ? i.column + (u ? 0 : 1)
                : i.indented + (u ? 0 : f)
              : i.indented + (/^(?:case|default)\b/.test(t) ? f : 2 * f);
          },
  ...
  (function (e) {
    ...
    var u =
      ...
      g = { "(": ")>", ")": "(<", "[": "]>", "]": "[<", "{": "}>", "}": "{<" };
    function d(e, t, r) {
      var n = e.getLineHandle(t.line),
        i = t.ch - 1,
        o = r && r.afterCursor;
      null == o &&
        (o = /(^| )cm-fat-cursor($| )/.test(e.getWrapperElement().className));
      var a = (!o && 0 <= i && g[n.text.charAt(i)]) || g[n.text.charAt(++i)];
      if (!a) return null;
      var l = ">" == a.charAt(1) ? 1 : -1;
      if (r && r.strict && 0 < l != (i == t.ch)) return null;
      var s = e.getTokenTypeAt(m(t.line, i + 1)),
        c = f(e, m(t.line, i + (0 < l ? 1 : 0)), l, s || null, r);
      return null == c
        ? null
        : {
            from: m(t.line, i),
            to: c && c.pos,
            match: c && c.ch == a.charAt(0),
            forward: 0 < l,
          };
    }
    function f(e, t, r, n, i) {
      for (
        var o = (i && i.maxScanLineLength) || 1e4,
          a = (i && i.maxScanLines) || 1e3,
          l = [],
          s = i && i.bracketRegex ? i.bracketRegex : /[(){}[\]]/,
          c =
            0 < r
              ? Math.min(t.line + a, e.lastLine() + 1)
              : Math.max(e.firstLine() - 1, t.line - a),
          u = t.line;
        u != c;
        u += r
      ) {
        var d = e.getLine(u);
        if (d) {
          var f = 0 < r ? 0 : d.length - 1,
            h = 0 < r ? d.length : -1;
          if (!(d.length > o))
            for (u == t.line && (f = t.ch - (r < 0 ? 1 : 0)); f != h; f += r) {
              var p = d.charAt(f);
              if (
                s.test(p) &&
                (void 0 === n || e.getTokenTypeAt(m(u, f + 1)) == n)
              )
                if ((">" == g[p].charAt(1)) == 0 < r) l.push(p);
                else {
                  if (!l.length) return { pos: m(u, f), ch: p };
                  l.pop();
                }
            }
        }
      }
      return u - r != (0 < r ? e.lastLine() : e.firstLine()) && null;
    }
    function t(e, t, r) {
      for (
        var n = e.state.matchBrackets.maxHighlightLineLength || 1e3,
          i = [],
          o = e.listSelections(),
          a = 0;
        a < o.length;
        ...
        var l = o[a].empty() && d(e, o[a].head, r);
        if (l && e.getLine(l.from.line).length <= n) {
          var s = l.match
            ? "CodeMirror-matchingbracket"
            : "CodeMirror-nonmatchingbracket";
          i.push(
            e.markText(l.from, m(l.from.line, l.from.ch + 1), { className: s })
          ),
            l.to &&
              e.getLine(l.to.line).length <= n &&
              i.push(
                e.markText(l.to, m(l.to.line, l.to.ch + 1), { className: s })
              );
        }
      }
      if (i.length) {
    ...
    function i(e) {
      e.operation(function () {
        e.state.matchBrackets.currentlyHighlighted &&
          ...
          (e.state.matchBrackets.currentlyHighlighted = t(
            e,
            !1,
    ...
    n.defineOption("matchBrackets", !1, function (e, t, r) {
      r &&
        r != n.Init &&
        ...
        e.state.matchBrackets &&
          ...
          (e.state.matchBrackets.currentlyHighlighted = null))),
        t &&
          ((e.state.matchBrackets = "object" == typeof t ? t : {}),
          e.on("cursorActivity", i));
    }),
      n.defineExtension("matchBrackets", function () {
        t(this, !0);
      }),
      n.defineExtension("findMatchingBracket", function (e, t, r) {
        return (
          (r || "boolean" == typeof t) &&
      ...
      n.defineExtension("scanForBracket", function (e, t, r, n) {
        return f(this, e, t, r, n);
      });
  }),
  (function (e) {
    "object" == typeof exports && "object" == typeof module
    ...
    function l(i, o, a) {
      return 0 == i.length
        ? s(o)
        : function (e, t) {
            for (var r = i[0], n = 0; n < r.length; n++)
              if (e.match(r[n][0]))
                return (t.tokenize = l(i.slice(1), o)), r[n][1];
            return (t.tokenize = s(o, a)), "string";
          };
    }
    function s(r, n) {
      return function (e, t) {
        return (function (e, t, r, n) {
          if ((!1 !== n && e.match("${", !1)) || e.match("{$", !1))
            return (t.tokenize = null), "string";
          if (!1 !== n && e.match(/^\$[a-zA-Z_][a-zA-Z0-9_]*/))
            return (
              e.match("[", !1) &&
                (t.tokenize = l(
                  [
    ...
    c.registerHelper("hintWords", "php", [t, r, n].join(" ").split(" ")),
      ...
      hooks: {
        ...
        "<": function (e, t) {
          ...
          if ((r = e.match(/<<\s*/))) {
            var n = e.eat(/['"]/);
            e.eatWhile(/[\w\.]/);
            var i = e.current().slice(r[0].length + (n ? 2 : 1));
            if ((n && e.eat(n), i))
              return (
                (t.tokStack || (t.tokStack = [])).push(i, 0),
                (t.tokenize = s(i, "'" != n)),
                "string"
              );
          }
        ...
        "}": function (e, t) {
          return (
            t.tokStack &&
              0 < t.tokStack.length &&
              !--t.tokStack[t.tokStack.length - 1] &&
              (t.tokenize = s(t.tokStack[t.tokStack.length - 2])),
            !1
          );
        },
      },
    ...
    c.defineMode(
      "php",
      function (e, r) {
        var l = c.getMode(e, (r && r.htmlMode) || "text/html"),
          s = c.getMode(e, i);
        return {
          startState: function () {
            var e = c.startState(l),
              t = r.startOpen ? c.startState(s) : null;
            return {
              html: e,
              php: t,
              curMode: r.startOpen ? s : l,
              curState: r.startOpen ? t : e,
              pending: null,
            };
          },
          copyState: function (e) {
          ...
          token: function (e, t) {
            ...
            if (
              ...
              return r && null == t.php.tokenize && e.match("?>")
                ? ((t.curMode = l),
                  (t.curState = t.html),
                  t.php.context.prev || (t.php = null),
                  "meta")
                : s.token(e, t.curState);
            if (e.match(/^<\?\w*/))
              return (
                (t.curMode = s),
                t.php || (t.php = c.startState(s, l.indent(t.html, ""))),
                (t.curState = t.php),
                "meta"
              );
            if ('"' == t.pending || "'" == t.pending) {
              ...
              t.pending && e.pos < t.pending.end
                ? ((e.pos = t.pending.end), (n = t.pending.style))
                : (n = l.token(e, t.curState));
    ...
    _.defineMode("xml", function (e, t) {
        ...
        return "<" == n
          ? t.eat("!")
            ? t.eat("[")
              ...
              : null
            : t.eat("?")
            ? (t.eatWhile(/[\w\._\-]/), (r.tokenize = i("meta", "?>")), "meta")
            : ((a = t.eat("/") ? "closeTag" : "openTag"),
              (r.tokenize = u),
              "tag bracket")
          : "&" == n
          ? (
      ...
      function u(e, t) {
        ...
        if (">" == i || ("/" == i && e.eat(">")))
          return (
            (t.tokenize = c),
            (a = ">" == i ? "endTag" : "selfcloseTag"),
            "tag bracket"
          );
        if ("=" == i) return (a = "equals"), null;
        if ("<" == i) {
          (t.tokenize = c), (t.state = p), (t.tagName = t.tagStart = null);
      ...
      function m(e, t, r) {
        return "word" == e
          ? ((r.tagName = t.current()), (o = "tag"), b)
          : s.allowMissingTagName && "endTag" == e
          ? ((o = "tag bracket"), b(e, t, r))
          : ((o = "error"), m);
      }
      function g(e, t, r) {
        if ("word" == e) {
        ...
        return s.allowMissingTagName && "endTag" == e
          ? ((o = "tag bracket"), v(e, t, r))
          : ((o = "error"), y);
      }
      function v(e, t, r) {
        return "endTag" != e ? ((o = "error"), v) : (f(r), p);
      }
      function y(e, t, r) {
        return (o = "error"), v(e, 0, r);
      }
      function b(e, t, r) {
        ...
        if ("endTag" == e || "selfcloseTag" == e) {
          ...
          return (
            ...
            "selfcloseTag" == e || s.autoSelfClosers.hasOwnProperty(n)
              ? h(r, n)
              : (h(r, n), (r.context = new d(r, n, i == r.indented))),
            p
          );
        }
        return (o = "error"), b;
      ...
      function w(e, t, r) {
        return "equals" == e
          ? x
          : (s.allowMissing || (o = "error"), b(e, 0, r));
      }
      function x(e, t, r) {
        return "string" == e
          ? k
          ...
          token: function (e, t) {
            ...
            return (
              (r || a) &&
                "comment" != r &&
                ((o = null),
                (t.state = t.state(a || r, e, t)),
                o && (r = "error" == o ? r + " error" : o)),
              r
            );
          },
          indent: function (e, t, r) {
            ...
            if (i && i[1])
              for (; n; ) {
                ...
                if (!s.implicitlyClosed.hasOwnProperty(n.tagName)) break;
                n = n.prev;
              }
            else if (i)
              for (; n; ) {
                var o = s.contextGrabbers[n.tagName];
                if (!o || !o.hasOwnProperty(i[2])) break;
                n = n.prev;
              }
            for (; n && n.prev && !n.startOfLine; ) n = n.prev;
            return n ? n.indent + l : e.baseIndent || 0;
          },
          electricInput: /<\/[\s\w:]+>$/,
      ...
      _.defineMIME("text/xml", "xml"),
      _.defineMIME("application/xml", "xml"),
      _.mimeModes.hasOwnProperty("text/html") ||
        _.defineMIME("text/html", { name: "xml", htmlMode: !0 });
  });
